...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, raw_abstract_nlp_phrases FROM database LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, raw_document_title_nlp_phrases FROM database LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
# ...         year_filter=(None, None),
...
# ...     ).build()
# ... )
                                           record_id                     raw_document_title_nlp_phrases
...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, local_citations FROM database LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
# ...         year_filter=(None, None),
...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, global_citations FROM database LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
# ...         year_filter=(None, None),
...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, global_references FROM database LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
# ...         year_filter=(None, None),
...
# ...     Query()
# ...     .set_analysis_params(
# ...         expr="SELECT record_id, local_references FROM database ORDER BY local_references LIMIT 5;"
# ...     ).set_database_params(
# ...         root_dir="example/",
# ...         database="main",
# ...         year_filter=(None, None),
