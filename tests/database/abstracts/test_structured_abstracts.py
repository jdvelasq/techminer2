...
Example:
    ...
    . the purpose of the study was to investigate STUDENTS ' readiness for
    ...
    SIGNIFICANT_SKILL_ENHANCEMENT . THESE_FINDINGS have practical implications for EDUCATORS ,
    ...
    social implications : the social implications of THIS_STUDY are noteworthy . in the
    ...
    THE_COMPONENTS , STRUCTURES and intended outcomes of THE_RESEARCH_PROJECT_COMPONENT of
