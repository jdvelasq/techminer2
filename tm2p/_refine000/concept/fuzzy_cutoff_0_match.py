...
from tm2p._refine000._intern.objs.thesaurus_match_result import ThesaurusMatchResult
from tm2p.refine._intern._rule import apply_fuzzy_zero_exact_match_rule
...
class FuzzyCutoffZeroWordMatch(
    ...
    def run(self) -> ThesaurusMatchResult:
        ...
        apply_fuzzy_zero_exact_match_rule(
