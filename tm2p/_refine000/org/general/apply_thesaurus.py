...
Smoke tests:
    ...
    >>> from tm2p.refine.thesaurus_old.organizations import ApplyThesaurus, InitializeThesaurus
...
from tm2p._refine000.thesaurus_old._intern import internal__transform
