...
Smoke test:
    ...
    >>> from tm2p.synthes.factor.tfidf import FactorMap
    >>> plot = (
    ...     FactorMap()
    ...     #
    ...     # FIELD:
...
from tm2p.synthes.factor.tfidf.cluster_centers_dataframe import cluster_centers_frame
from tm2p.synthes.factor.tfidf.cluster_to_items_mapping import cluster_to_terms_mapping
