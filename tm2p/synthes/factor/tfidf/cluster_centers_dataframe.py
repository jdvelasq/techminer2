...
Smoke test:
    ...
    >>> from tm2p.synthes.factor.tfidf import ClusterCentersDataFrame
    >>> (
    ...     ClusterCentersDataFrame()
    ...     #
    ...     # FIELD:
...
from tm2p.synthes.factor.tfidf.items_by_dimension_dataframe import (
    terms_by_dimension_frame,
)
from tm2p.synthes.factor.tfidf.items_to_cluster_mapping import terms_to_cluster_mapping
