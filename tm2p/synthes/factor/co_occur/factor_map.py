...
Smoke test:
    ...
    >>> from tm2p.synthes.factor.co_occur import FactorMap
    >>> plot = (
    ...     FactorMap()
    ...     #
    ...     # FIELD:
...
from tm2p.synthes.factor.co_occur.cluster_centers_dataframe import cluster_centers_frame
from tm2p.synthes.factor.co_occur.cluster_to_items_mapping import (
