...
from tm2p._internals.nx.assign_degree_to_nodes import internal__assign_degree_to_nodes
from tm2p.synthes.intellect_struct.citation._internals.from_others.create_nx_graph import (
