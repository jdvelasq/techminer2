...
Smoke tests:
    >>> from tm2p.co_occurrence_network.descriptors import NodeDensityPlot
    >>> plot = (
    ...     NodeDensityPlot()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.co_occurrence.descriptors.node_density_plot.html")
