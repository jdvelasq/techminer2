...
Smoke tests:
    >>> from tm2p.packages.networks.co_authorship.organizations import NodeDegreePlot
    >>> plot = (
    ...     NodeDegreePlot()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.co_authorship.organizations.node_degree_plot.html")
