...
Smoke tests:
    >>> from tm2p.packages.networks.co_authorship.countries import NodeDegreePlot
    >>> plot = (
    ...     NodeDegreePlot()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.co_authorship.countries.node_degree_plot.html")
