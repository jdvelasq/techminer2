...
Smoke tests:
    ...
    >>> from tm2p.portfolio.thematic_struct.co_occur.direct_similarity_network import Treemap
    >>> fig = (
    ...     Treemap()
    ...     #
    ...     # FIELD:
...
#     plot_node_treemap,
# )
from tm2p.portfolio.thematic_struct.co_occur._first_order_network_._intern.create_nx_graph import (
    create_nx_graph,
)
