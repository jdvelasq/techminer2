...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.thematic_struct.co_occur.latent_similarity_network.density_plot.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import AssociationIndex, AnalysisUnit, GraphClusteringAlgorithm, UnitOrderBy, Scaling, NodeSizeMetric
    >>> from tm2p.portfolio.thematic_struct.co_occur.latent_simil_netw import DensityPlot
    >>> fig = (
    ...     DensityPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    ...     .run()
    ... )
    >>> assert type(fig).__name__ == 'Figure'    >>> fig.write_html("docsrc/_generated/px.portfolio.thematic_struct.co_occur.latent_similarity_network.density_plot.html")
...
from ..dir_simil_netw import Matrix as CoOccurrenceMatrix
