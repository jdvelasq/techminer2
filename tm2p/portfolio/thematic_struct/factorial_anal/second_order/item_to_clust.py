...
Smoke test:
    ...
    >>> from tm2p.portfolio.thematic_struct.factorial_analysis.second_order import ItemToCluster
    >>> mapping = (
    ...     ItemToCluster()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_struct.factorial_anal.second_order.item_by_dim import (
    ItemsByDimension,
)
