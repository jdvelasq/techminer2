...
Smoke test:
    ...
    >>> from tm2p.portfolio.thematic_struct.factorial_analysis.first_order import ItemsByDimension
    >>> df = (
    ...     ItemsByDimension()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_struct.tfidf.matrix import Matrix
