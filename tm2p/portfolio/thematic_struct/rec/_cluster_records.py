...
# >>> from tm2p.visualize.specialized_charts import cluster_records
...
# ... )
# >>> plot.write_html("docsrc/_generated/px.visualize/specialized_charts/cluster_records.html")
...
# from tm2p.analyze.tfidf.data_frame import DataFrame as tfidf_frame
