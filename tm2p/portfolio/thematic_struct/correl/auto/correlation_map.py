...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.thematic_struct.correlation.auto.correlation_map.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.thematic_struct.correlation.auto import CorrelationMap
    >>> plot = (
    ...     CorrelationMap()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.portfolio.thematic_struct.correlation.auto.correlation_map.html")
...
from tm2p._intern.plots.adv import build_correlation_map
