...
from tm2p.portfolio.thematic_structure.co_occurrence.latent_similarity_network._items_by_dimension import (
    terms_by_dimension_frame,
)
from tm2p.portfolio.thematic_structure.co_occurrence.latent_similarity_network._manifold_2d_map import (
    manifold_2d_map,
)
