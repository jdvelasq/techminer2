...
Smoke tests:
    ...
    >>> from tm2p.portfolio.thematic_structure.co_occurrence.first_order_network import ItemsByCluster
    >>> df = (
    ...     ItemsByCluster()
    ...     #
    ...     # FIELD:
    ...
    >>> from tm2p.portfolio.thematic_structure.co_occurrence.first_order_network import NetworkPlot
    >>> fig = (
    ...     NetworkPlot()
    ...     #
    ...     # FIELD:
