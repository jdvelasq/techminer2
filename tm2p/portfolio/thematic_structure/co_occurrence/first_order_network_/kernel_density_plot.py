...
Smoke tests:
    ...
    >>> from tm2p.portfolio.thematic_structure.co_occurrence.first_order_network import KernelDensityPlot
    >>> fig = (
    ...     KernelDensityPlot()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_structure.co_occurrence.first_order_network_._intern.create_nx_graph import (
    create_nx_graph,
)
