...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.thematic_structure.co_occurrence.first_order_network.heatmap.html"
    height="600px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import AssociationIndex, Field, ItemOrderBy
    >>> from tm2p.portfolio.thematic_structure.co_occurrence.first_order_network import Heatmap
    >>> fig = (
    ...     Heatmap()
    ...     #
    ...     # FIELD:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.thematic_structure.co_occurrence.first_order_network.heatmap.html")
