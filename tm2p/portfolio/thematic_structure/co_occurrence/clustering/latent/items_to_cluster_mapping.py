...
from tm2p.portfolio.thematic_structure.co_occurrence.clustering.latent.items_by_dimension import (
    terms_by_dimension_frame,
)
from tm2p.portfolio.thematic_structure.co_occurrence.clustering.latent.terms_to_cluster_mapping import (
