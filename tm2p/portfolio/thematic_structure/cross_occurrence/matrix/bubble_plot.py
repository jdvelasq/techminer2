...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.thematic_structure.cross_occurrence.matrix.bubble_plot.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p import Field, ItemOrderBy
    >>> from tm2p.portfolio.thematic_structure.cross_occurrence.matrix import BubblePlot
    >>> fig = (
    ...     BubblePlot()
    ...     #
    ...     # COLUMNS:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.thematic_structure.cross_occurrence.matrix.bubble_plot.html")
...
class BubblePlot(
    ...
    def run(self):
        ...
        from tm2p.portfolio.thematic_structure.cross_occurrence.matrix.matrix_list import (
            MatrixList,
        )
