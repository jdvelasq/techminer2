...
Smoke tests:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.emergence.topic_trends.scientopy.topic_dynamics_plot.html")
...
from tm2p.portfolio.emergence.topic_trends.scientopy.topic_dynamics import TopicDynamics
