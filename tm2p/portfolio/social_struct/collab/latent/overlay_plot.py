...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.social_struct.collab.latent.overlay_plot.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import AssociationIndex, AnalysisUnit, GraphClusteringAlgorithm, UnitOrderBy, Scaling, NodeSizeMetric
    >>> from tm2p.portfolio.social_struct.collab.latent import OverlayPlot
    >>> fig = (
    ...     OverlayPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.social_struct.collab.latent.overlay_plot.html")
