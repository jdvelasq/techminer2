...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.social_struct.collab.direct.density_plot.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.social_struct.collab.direct import DensityPlot  # type: ignore
    >>> fig = (
    ...     DensityPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.social_struct.collab.direct.density_plot.html")
