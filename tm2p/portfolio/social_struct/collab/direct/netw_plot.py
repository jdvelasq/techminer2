...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.social_struct.collab.direct.network_plot.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.social_struct.collab.direct import NetworkPlot  # type: ignore
    >>> fig = (
    ...     NetworkPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.social_struct.collab.direct.network_plot.html")
