...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.social_structure.collab.bar_plot.html"
...
Smoke tests:
    ...
    ...     .run()
    ... )
    >>> assert type(fig).__name__ == 'Figure'    >>> fig.write_html("docsrc/_generated/px.portfolio.social_structure.collab.bar_plot.html")
...
from tm2p.portfolio.social_struct.perf.metrics import Metrics
