...
.. raw:: html
    ...
    <iframe src="../_static/px.portfolio.intellect_struct.co_cit_netw.direct.overlay_plot_cited_auth.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.co_cit_netw.direct import OverlayPlot  # type: ignore
    >>> plot = (
    ...     OverlayPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.portfolio.intellect_struct.co_cit_netw.direct.overlay_plot_cited_auth.html")
