...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.intellect_struct.coupling_network.overlay_plot_doc.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import AssociationIndex, AnalysisUnit, GraphClusteringAlgorithm, UnitOrderBy, Scaling, NodeSizeMetric
    >>> from tm2p.portfolio.intellect_struct.coupl_netw import OverlayPlot
    >>> fig = (
    ...     OverlayPlot()
    ...     #
    ...     # COUPLING UNIT:
    ...
    ...     .run()
    ... )
    >>> assert type(fig).__name__ == 'Figure'    >>> fig.write_html("docsrc/_generated/px.portfolio.intellect_struct.coupling_network.overlay_plot_doc.html")
