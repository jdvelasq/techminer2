...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.intellect_struct.coupling_network.density_plot_doc.html"
...
Smoke tests:
    ...
    ...     .run()
    ... )
    >>> assert type(fig).__name__ == 'Figure'    >>> fig.write_html("docsrc/_generated/px.portfolio.intellect_struct.coupling_network.density_plot_doc.html")
