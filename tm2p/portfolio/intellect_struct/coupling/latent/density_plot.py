...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.intellect_struct.coupling.latent.density_plot_doc.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.coupling.latent import DensityPlot  # type: ignore
    >>> fig = (
    ...     DensityPlot()
    ...     #
    ...     # COUPLING UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.intellect_struct.coupling.latent.density_plot_doc.html")
