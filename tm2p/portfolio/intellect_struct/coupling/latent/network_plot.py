...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.intellect_struct.coupling.latent.network_plot_doc.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.coupling.latent import NetworkPlot  # type: ignore
    >>> fig = (
    ...     NetworkPlot()
    ...     #
    ...     # COUPLING UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.intellect_struct.coupling.latent.network_plot_doc.html")
