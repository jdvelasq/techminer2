...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.intellect_struct.coupling.direct.overlay_plot_doc.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.coupling.direct import OverlayPlot  # type: ignore
    >>> fig = (
    ...     OverlayPlot()
    ...     #
    ...     # COUPLING UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.intellect_struct.coupling.direct.overlay_plot_doc.html")
