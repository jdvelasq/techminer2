...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.coupling.direct import UnitToCluster  # type: ignore
    >>> mapping = (
    ...     UnitToCluster()
    ...     #
    ...     # COUPLING UNIT:
    ...
    {'Abaddi S, 2025, NAT RESOUR FORUM 1:00004': 0,
     ...
     'Abbaspour H, 2018, INT J MIN SCI TECHNOL 1:00044': 0,
     'Abdallah KS, 2022, INT J IND ENG-THEORY APPL PR 1:00002': 0,
     'Abdi-Dehkordi M, 2021, ENV DEV SUSTAIN 1:00014': 0,
     'Aboah J, 2023, PLOS 1:00004': 5,
     'Abraham M, 2022, AQUA 1:00002': 1,
     'Adeogun A, 2025, HEAL 1:00003': 5,
    ...
