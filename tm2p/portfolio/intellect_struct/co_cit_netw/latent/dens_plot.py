...
.. raw:: html
    ...
    <iframe src="../_static/px.portfolio.intellect_struct.co_cit_netw.latent.dens_plot_cited_auth.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellect_struct.co_cit_netw.latent import DensityPlot  # type: ignore
    >>> plot = (
    ...     DensityPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.portfolio.intellect_struct.co_cit_netw.latent.dens_plot_cited_auth.html")
