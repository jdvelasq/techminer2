"""
CumulativeGrowthPlot
===============================================================================

.. raw:: html

    <iframe src="../_generated/px.portfolio.temporal_evol.life_cycle.cumul_growth_plot.html"
    height="800px" width="100%" frameBorder="0"></iframe>


Smoke test:
    >>> from tm2p.portfolio.temporal_evol.life_cycle import CumulativeGrowthPlot
    >>> fig = (
    ...     CumulativeGrowthPlot()
    ...     #
    ...     .using_title_text("Cumulative Growth Plot")
    ...     #
    ...     # DATABASE:
