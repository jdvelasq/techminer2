...
Smoke tests:
    >>> from tm2p.analyze.annual_metrics import Column
    >>> from tm2p.analyze.annual_metrics import RankingPlot
    >>> fig = (
    ...     RankingPlot()
    ...     #
...
from tm2p.portfolio.performance_mapping.annual_metrics.metrics import Metrics
