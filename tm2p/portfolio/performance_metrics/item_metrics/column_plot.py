...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.performance_metrics.item_metrics.column_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import Field, ItemOrderBy
    >>> from tm2p.portfolio.performance_metrics.item_metrics import ColumnPlot
    >>> plot = (
    ...     ColumnPlot()
    ...     #
    ...     # FIELD:
    ...
    >>> type(plot).__name__
    'Figure'
    >>> plot.write_html("docsrc/_generated/px.portfolio.performance_metrics.item_metrics.column_plot.html")
