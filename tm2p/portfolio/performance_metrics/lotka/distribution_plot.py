...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.performance_metrics.lotka.distribution_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from tm2p.portfolio.performance_metrics.lotka import DistributionPlot
    >>> fig = (
    ...     DistributionPlot()
    ...     #
    ...     # DATABASE:
...
from tm2p.portfolio.performance_metrics.lotka.distribution import Distribution
