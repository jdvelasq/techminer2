...
Smoke test:
    ...
    >>> from tm2p.synthesize.factor.tfidf import ClusterToItemsMapping
    >>> mapping = (
    ...     ClusterToItemsMapping()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_stucture.factorial_analysis.first_order.item_to_cluster import (
    ItemToCluster,
)
