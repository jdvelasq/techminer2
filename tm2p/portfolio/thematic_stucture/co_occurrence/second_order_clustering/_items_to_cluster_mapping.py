...
Smoke test:
    ...
    >>> from tm2p.synthesize.factor.co_occur import ItemsToClusterMapping
    >>> mapping = (
    ...     ItemsToClusterMapping()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_stucture.co_occurrence.second_order_clustering._items_by_dimension import (
    terms_by_dimension_frame,
)
from tm2p.portfolio.thematic_stucture.co_occurrence.second_order_clustering._terms_to_cluster_mapping import (
