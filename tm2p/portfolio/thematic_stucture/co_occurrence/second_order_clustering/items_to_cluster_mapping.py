...
from tm2p.portfolio.thematic_stucture.co_occurrence.second_order_clustering.items_by_dimension import (
    terms_by_dimension_frame,
)
from tm2p.portfolio.thematic_stucture.co_occurrence.second_order_clustering.terms_to_cluster_mapping import (
