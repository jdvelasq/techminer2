...
Smoke tests:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.thematic_stucture.co_occurrence.second_order_matrix.heatmap.html")
...
from ..latent_similarity_network.latent_matrix import LatentMatrix
