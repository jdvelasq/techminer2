...
Smoke tests:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.thematic_stucture.co_occurrence.latent_similarity_network.overlay_plot.html")
...
from tm2p.portfolio.performance_metrics.trends.trends import Trends
...
class OverlayPlot(
    ...
    def run(self):
        ...
        fig = build_co_occ_overlay_plot(
            ...
            co_occurrence_matrix=similarity_matrix,
            i2c=i2c,
            i2y=i2y,
        )
