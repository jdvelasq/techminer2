...
Smoke test:
    ...
    >>> from tm2p.portfolio.thematic_stucture.factorial_analysis.first_order import ItemsByDimension
    >>> df = (
    ...     ItemsByDimension()
    ...     #
    ...     # FIELD:
...
from tm2p.portfolio.thematic_stucture.tfidf.matrix import Matrix
