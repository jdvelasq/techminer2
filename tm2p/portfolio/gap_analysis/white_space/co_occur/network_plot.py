...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.gap_analysis.white_space.co_occur.network_plot.html"
...
Smoke tests:
    ...
    >>> from tm2p.portfolio.gap_analysis.white_space.co_occur import NetworkPlot  # type: ignore
    >>> fig = (
    ...     NetworkPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    >>> fig.write_html("docsrc/_generated/px.portfolio.gap_analysis.white_space.co_occur.network_plot.html")
...
class NetworkPlot(
    ...
    def run(self):
        ...
        fig = build_co_occ_network_plot(
            params=self.params,
            similarity_matrix=white_space_matrix,
            co_occurrence_matrix=white_space_matrix,
            i2c=i2c,
        )
