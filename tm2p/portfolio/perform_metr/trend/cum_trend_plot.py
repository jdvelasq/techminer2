...
.. raw:: html
    ...
    <iframe src="../_generated/px.portfolio.performance_metrics.trends.cumulative_trends_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from tm2p.enum import AnalysisUnit, UnitOrderBy
    >>> from tm2p.portfolio.perform_metr.trends import CumulativeTrendsPlot
    >>> fig = (
    ...     CumulativeTrendsPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    ...     .run()
    ... )
    >>> fig.write_html("docsrc/_generated/px.portfolio.performance_metrics.trends.cumulative_trends_plot.html")
...
from .cum_trend import CumulativeTrends
