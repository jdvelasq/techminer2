...
Smoke test:
    ...
    >>> from tm2p.papers.thematic.first_order_factors import ItemToCluster
    >>> mapping = (
    ...     ItemToCluster()
    ...     #
    ...     # FIELD:
...
from tm2p.papers.thematic.first_order_factors.items_by_dimension import ItemsByDimension
