...
Smoke test:
    ...
    >>> from tm2p.synthesize.factor.tfidf import CosineSimilarities
    >>> (
    ...     CosineSimilarities()
    ...     #
    ...     # FIELD:
...
from tm2p.portf.themat_struct.fact_analysis.fst_ord.item_by_dim import ItemsByDimension
