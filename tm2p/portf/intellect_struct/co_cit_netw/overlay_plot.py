...
.. raw:: html
    ...
    <iframe src="../_static/px.portfolio.intelectual_structure.co_citation_network.overlay_plot_cited_auth.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from tm2p.enum import AssociationIndex, AnalysisUnit, GraphClusteringAlgorithm, NodeSizeMetric, Scaling
    >>> from tm2p.portfolio.intellectual_structure.co_citation_network import OverlayPlot
    >>> plot = (
    ...     OverlayPlot()
    ...     #
    ...     # ANALYSIS UNIT:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.portfolio.intelectual_structure.co_citation_network.overlay_plot_cited_auth.html")
