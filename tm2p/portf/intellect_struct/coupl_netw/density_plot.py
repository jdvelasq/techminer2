...
Smoke tests:
    ...
    >>> from tm2p.portfolio.intellectual_structure.coupling_network import DensityPlot
    >>> fig = (
    ...     DensityPlot()
    ...     #
    ...     # COUPLING UNIT:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.portfolio.intellectual_structure.coupling_network.density_plot_doc.html")
