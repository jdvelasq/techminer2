...
def build_wos_enrich_steps(params: Params) -> list[Step]:
    ...
    from .s04_ctry_wos import s04_ctry_wos
    ...
    from .s09_org_wos import s09_org_wos
    from .s10_org_first import s10_org_first
    from .s99_n_gcr_wos import s03_n_gcr_wos
    ...
    return [
        ...
        Step(
            ...
            function=s03_n_gcr_wos,
            kwargs=common_kwargs,
        ),
        Step(
            name="Extracting CTRY",
            function=s04_ctry_wos,
            kwargs=common_kwargs,
        ),
        Step(
