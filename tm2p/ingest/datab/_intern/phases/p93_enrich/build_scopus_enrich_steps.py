...
def build_scopus_enrich_steps(params: Params) -> list[Step]:
    ...
    from .s04_ctry_scopus import s04_ctry_scopus
    ...
    from .s09_org_scopus import s09_org_scopus
    from .s10_org_first import s10_org_first
    from .s99_n_gcr_scopus import s03_n_gcr_scopus
    ...
    return [
        ...
        Step(
            ...
            function=s03_n_gcr_scopus,
            kwargs=common_kwargs,
        ),
        Step(
            name="Extracting CTRY",
            function=s04_ctry_scopus,
            kwargs=common_kwargs,
        ),
        Step(
