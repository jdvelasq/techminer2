...
Smoke tests:
    >>> from tm2p.packages.co_occurrence_matrix import SankeyPlot
    >>> plot = (
    ...     SankeyPlot()
    ...     #
    ...     # FIELDS:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.co_occurrence_matrix.sankey_plot.html")

.. raw:: html

    <iframe src="../_generated/px.packages.co_occurrence_matrix/sankey_plot.html"
...
class SankeyPlot(
    ...
    def _step_01_build_matrices(self):
        ...
        matrices = []
        fields = [self.params.source_field] + self.params.index_field
