...
Smoke tests:
    ...
    >>> from tm2p.discov.co_occurrence_matrix._internals import Heatmap
    >>> fig = (
    ...     Heatmap()
    ...     #
    ...     # FIELD:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discov.co_occurrence_matrix._internals.heatmap.html")
