...
.. raw:: html
    ...
    <iframe src="../_generated/px.discov.co_occurrence_matrix._internals.matrix_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from tm2p import CorpusField, ItemsOrderBy
    >>> from tm2p.discov.co_occurrence_matrix._internals import MatrixPlot
    >>> fig = (
    ...     MatrixPlot()
    ...     #
    ...     # FIELD:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discov.co_occurrence_matrix._internals.matrix_plot.html")

"""

from tm2p._internals import ParamsMixin

from ...occur_matrix._internals.matrix_plot import MatrixPlot as BaseMatrixPlot
