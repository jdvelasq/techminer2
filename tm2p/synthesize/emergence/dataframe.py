...
from tm2p.discover.overview import MainInformation as GeneralMetricsDataFrame
from tm2p.discover.overview.average_citations_per_year.dataframe import (
...
class DataFrame(
    ...
    def _step_1_compute_term_occurrences_by_year(self):
        ...
        from tm2p.analyze._internals.items_by_year import (
