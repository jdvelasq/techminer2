...
Smoke tests:
    >>> from techminer2.packages.networks.co_authorship.authors import ClustersToTermsMapping
    >>> mapping = (
...
from tm2p.synthesize.conceptual_structure.co_occurrence.usr.clusters_to_terms_mapping import (
