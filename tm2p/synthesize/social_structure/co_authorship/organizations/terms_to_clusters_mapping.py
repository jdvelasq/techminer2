...
Smoke tests:
    ...
    {'Baylor Univ (USA) 2:0395': 2,
     ...
     '[UKN] Stanford GSB and the Hoover Inst, United States (USA) 1:0390': 1}
    ...
    {'Baylor Univ (USA)': 2,
     ...
     '[UKN] Stanford GSB and the Hoover Inst, United States (USA)': 1}
...
from tm2p.synthesize.conceptual_structure.co_occurrence.usr.terms_to_clusters_mapping import (
