...
Smoke tests:
    ...
    >>> # CODE TESTED
    >>> #
    >>> from techminer2.co_occurrence_network.author_keywords import NetworkMetrics
    >>> df = (
    ...     NetworkMetrics()
    ...     #
    ...     # FIELD:
...
from tm2p.synthesize.conceptual_structure.co_occurrence.usr.network_metrics import (
