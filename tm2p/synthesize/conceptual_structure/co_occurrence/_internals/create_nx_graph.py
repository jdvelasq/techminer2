...
from tm2p.discover.co_occurrence_matrix._internals import Matrix as CoOccurrenceMatrix
from tm2p.discover.occurrence_matrix._internals.normalize_matrix import (
    _normalize_matrix,
)
