...
from tm2p.synthesize.conceptual_structure.factor_analysis.co_occurrence.terms_by_dimension_data_frame import (
    terms_by_dimension_frame,
)
from tm2p.synthesize.conceptual_structure.factor_analysis.co_occurrence.terms_to_cluster_mapping import (
