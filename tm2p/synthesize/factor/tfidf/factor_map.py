...
Smoke test:
    ...
    >>> from tm2p.synthesize.factor.tfidf import FactorMap
    >>> plot = (
    ...     FactorMap()
    ...     #
    ...     # FIELD:
...
from tm2p.synthesize.factor.tfidf.cluster_centers_dataframe import cluster_centers_frame
from tm2p.synthesize.factor.tfidf.cluster_to_items_mapping import (
