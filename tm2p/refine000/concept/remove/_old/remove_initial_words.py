...
Smoke tests:
    ...
    >>> from tm2p.refine.thesaurus_old.descriptors import InitializeThesaurus, RemoveInitialWords
...
from tm2p.refine000.thesaurus_old._intern import ThesaurusMixin
...
class RemoveInitialWords(
    ...
    def internal__remove_initial_words_from_keys(self):
        ...
        words = load_builtin_word_list("common_initial_words.txt")
