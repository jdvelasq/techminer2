...
Smoke tests:
    ...
    >>> from tm2p.refine.thesaurus_old.descriptors import ClumpKeys, InitializeThesaurus
...
# from tm2p.refine000.thesaurus_old.user import ClumpKeys as UserClumpKeys
