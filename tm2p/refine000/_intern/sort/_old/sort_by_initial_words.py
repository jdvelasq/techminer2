...
Smoke tests:
    ...
    >>> from tm2p.refine.thesaurus_old.user import SortByInitialWords
    >>> (
    ...     SortByInitialWords()
    ...     .with_thesaurus_file("demo.the.txt")
    ...     .where_root_directory("tests/scopus/")
...
from tm2p.refine000.thesaurus_old._intern import ThesaurusMixin, ThesaurusResult
...
class SortByInitialWords(
    ...
    def _select_data_frame_rows(self):
        ...
        patterns = load_builtin_word_list("common_initial_words.txt")
