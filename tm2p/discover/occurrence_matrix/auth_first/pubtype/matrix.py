...
Smoke tests:
    ...
    >>> from techminer2.discover.occurrence_matrix.auth_first.pubtype import Matrix
    >>> df = (
    ...     Matrix()
    ...     #
    ...     # COLUMNS:
    ...
    rows                                               ...
    Article 142:32733                               2  ...                      2
    Review 014:03303                                0  ...                      0
    Book 008:00553                                  0  ...                      0
    Conference paper 007:00872                      0  ...                      0
    Editorial 003:00322                             1  ...                      0
