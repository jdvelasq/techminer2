...
Smoke tests:
    ...
    >>> from techminer2.discover.occurrence_matrix.auth_first.concept import Matrix
    >>> df = (
    ...     Matrix()
    ...     #
    ...     # COLUMNS:
    ...
    rows                                                   ...
    fintech 155:33245                                   3  ...                      2
    financial technology 051:09258                      0  ...                      1
    finance 050:10972                                   0  ...                      1
    innovation 033:07734                                0  ...                      0
    china 033:06419                                     0  ...                      0
    financial services 030:06887                        0  ...                      0
    banks 029:06252                                     2  ...                      0
    technology 028:05172                                0  ...                      0
