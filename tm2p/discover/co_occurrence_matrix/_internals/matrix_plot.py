...
.. raw:: html
    ...
    <iframe src="../_generated/px.discover.co_occurrence_matrix._internals.matrix_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from techminer2 import CorpusField, ItemsOrderBy
    >>> from techminer2.discover.co_occurrence_matrix._internals import MatrixPlot
    >>> fig = (
    ...     MatrixPlot()
    ...     #
    ...     # FIELD:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discover.co_occurrence_matrix._internals.matrix_plot.html")

"""

from tm2p._internals import ParamsMixin

from ...occurrence_matrix._internals.matrix_plot import MatrixPlot as BaseMatrixPlot
