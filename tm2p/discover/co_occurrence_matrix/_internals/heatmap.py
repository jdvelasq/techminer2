...
Smoke tests:
    ...
    >>> from techminer2.discover.co_occurrence_matrix._internals import Heatmap
    >>> fig = (
    ...     Heatmap()
    ...     #
    ...     # FIELD:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discover.co_occurrence_matrix._internals.heatmap.html")
