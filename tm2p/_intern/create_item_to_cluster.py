from .assign_cluter_numbers_by_cluster_size import assign_cluter_numbers_by_cluster_size


def create_item_to_cluster(items: list[str], clusters: list[int]):

    cluster_to_items = assign_cluter_numbers_by_cluster_size(items, clusters)
    item_to_cluster = {}
