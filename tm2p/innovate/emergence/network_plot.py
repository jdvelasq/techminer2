...
.. raw:: html
    ...
    <iframe src="../_generated/px.innovate.emergence.network_plot.html"
    height="800px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from tm2p.innovate.emergence import NetworkPlot
    >>> plot = (
    ...     NetworkPlot()
    ...     #
    ...     # EMERGENCE:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.innovate.emergence.network_plot.html")
...
from tm2p.innovate.emergence.mixins import RecursiveClusteringMixin
from tm2p.synthesize.netw.co_occur import NetworkPlot as ClassicalNetworkPlot
