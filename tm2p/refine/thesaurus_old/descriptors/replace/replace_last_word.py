...
Smoke tests:
    ...
    >>> from tm2p.refine.thesaurus_old.descriptors import InitializeThesaurus, ReplaceLastWord
...
from tm2p.refine.thesaurus_old.user import ReplaceLastWord as UserReplaceEndsWithWord
