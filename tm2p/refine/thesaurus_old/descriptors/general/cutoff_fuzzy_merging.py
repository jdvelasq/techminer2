...
Smoke tests:
    ...
    >>> # Cutoff Fuzzy Merging
    >>> from tm2p.refine.thesaurus_old.descriptors import CutoffFuzzyMerging
    >>> (
...
from tm2p.refine.thesaurus_old.user import CutoffFuzzyMerging as UserCutoffFuzzyMerging
