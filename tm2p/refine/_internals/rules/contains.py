...
def apply_contains_rule(
    ...
    contains_df = thesaurus_df[
        thesaurus_df[PREFERRED].str.contains(params.pattern)
    ].copy()

    candidates_0_df = contains_df[contains_df["word_count"] == 1].copy()
    ...
    candidates_1_df = contains_df[contains_df["word_count"] >= 2].copy()
