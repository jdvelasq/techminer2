...
.. raw:: html
    ...
    <iframe src="../../../../_static/bibliometrix__index_keywords_dynamics.html" height="600px" width="100%" frameBorder="0"></iframe>
...
by year of the 'index_keywords' in a scientific bibliography database. Summarize the table \\
