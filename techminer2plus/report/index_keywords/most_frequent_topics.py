...
>>> file_name = "sphinx/_static/bibliometrix__index_keywords_most_frequent_topics.html"

>>> import techminer2plus
>>> r = techminer2plus.report.index_keywords.most_frequent_topics(
...     root_dir=root_dir,
...     top_n=20,
... )
...
.. raw:: html
    ...
    <iframe src="../../../../_static/bibliometrix__index_keywords_most_frequent_topics.html" height="600px" width="100%" frameBorder="0"></iframe>
...
'index_keywords' field in a scientific bibliography database. Summarize the table below, \\
...
| FINANCIAL_SERVICES_INDUSTRIES   |     2 |             1 |                   1 |                 11 |                 3 |                            5.5  |                           1.5  |                   0   |                     0.5 |                    0.25     |                     2017 |     7 |                        1.57 |         1 |         1 |      0.14 |
...
| REGULATORY_REQUIREMENTS         |     2 |             1 |                   1 |                  2 |                 0 |                            1    |                           0    |                  -0.5 |                     0.5 |                    0.25     |                     2021 |     3 |                        0.67 |         1 |         1 |      0.33 |
```
<BLANKLINE>
