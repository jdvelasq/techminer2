...
>>> lotka = techminer2plus.analyze.lotka_law(root_dir=root_dir)
>>> lotka.plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../_static/analyze/lotka_law.html" height="600px" width="100%" frameBorder="0"></iframe>
