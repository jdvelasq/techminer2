...
>>> coupling_network = techminer2plus.analyze.coupling.coupling_network(
...    coupling_matrix,
...
>>> print(techminer2plus.analyze.network.network_communities(coupling_network).to_markdown())
|    | CL_00                                                                      | CL_01                                                           | CL_02                                                    |
|---:|:---------------------------------------------------------------------------|:----------------------------------------------------------------|:---------------------------------------------------------|
...
"""
from ..network import cluster_network
