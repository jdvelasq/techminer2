...
>>> FILE_NAME = "sphinx/_static/use_cases/organizations/g_index.html"
>>> import techminer2plus
>>> items = techminer2plus.use_cases.organizations.g_index(
...     top_n=20,
...
.. raw:: html
    ...
    <iframe src="../../_static/use_cases/organizations/g_index.html" height="600px" width="100%" frameBorder="0"></iframe>
...
Kingston Bus Sch (GBR)              8        2    1  ...      1.0      1.0     0.17
FinTech HK, Hong Kong (HKG)         9        3    1  ...      1.0      1.0     0.14
<BLANKLINE>
[5 rows x 18 columns]
