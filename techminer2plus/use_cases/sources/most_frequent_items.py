...
>>> FILE_NAME = "sphinx/_static/use_cases/sources/most_frequent_items.html"
>>> import techminer2plus
>>> result = techminer2plus.use_cases.sources.most_frequent_items(
...     top_n=20,
...     root_dir="data/regtech/",
... )
>>> result.ranking_chart_.write_html(FILE_NAME)
