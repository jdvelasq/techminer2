...
>>> stats = techminer2plus.user.overview.main_information(root_dir)
>>> stats.table_
                                                            Value
Category       Item                                              
...
KEY CONCEPTS   Raw key concepts                               373
               Cleaned key concepts                           338
            
               
>>> file_name = "sphinx/_static/techminer2plus__main_info_plot.html"               
>>> stats.plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../_static/techminer2plus__main_info_plot.html" height="800px" width="100%" frameBorder="0"></iframe>
...
| ('KEY CONCEPTS', 'Raw key concepts')                   | 373       |
| ('KEY CONCEPTS', 'Cleaned key concepts')               | 338       |
```
<BLANKLINE>
