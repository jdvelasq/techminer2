...
>>> matrix = techminer2plus.analyze.matrix.auto_correlation_matrix(
...     rows_and_columns='authors',
...     top_n=10,
...     root_dir=root_dir,
... )

>>> matrix_list = techminer2plus.analyze.matrix.list_cells_in_matrix(matrix)
...
|  5 | Barberis JN 2:161 | Buckley RP 3:185  |   0.77 |
|  6 | Arner DW 3:185    | Barberis JN 2:161 |   0.77 |
| 12 | Hamdan A 2:018    | Turki M 2:018     |   1    |
| 16 | Lin W 2:017       | Singh C 2:017     |   1    |
| 20 | Brennan R 2:014   | Crane M 2:014     |   1    |
```
<BLANKLINE>
