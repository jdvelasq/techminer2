...
>>> techminer2plus.publish.authors.lotka_law(root_dir=root_dir).plot_.write_html(file_name)
...
>>> techminer2plus.publish.authors.lotka_law(root_dir=root_dir).table_
