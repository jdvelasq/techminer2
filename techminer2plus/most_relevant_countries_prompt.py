...
"""
.. _most_relevant_countries_prompt:

Most Relevant Countries Prompt
===============================================================================

>>> root_dir = "data/regtech/"
>>> import techminer2plus as tm2p
>>> prompt = tm2p.most_relevant_countries_prompt(
...    top_n=10,
...    root_dir=root_dir,
... )
>>> print(prompt)
...
table below, sorted by the 'OCCGC' metric, and delimited by triple \\
...
def most_relevant_countries_prompt(
    #
    # ITEM FILTERS:
    top_n=None,
    occ_range=(None, None),
