...
>>> svd_factor_matrix = techminer2plus.factor_matrix.svd_factor_matrix(
...     cooc_matrix,
... )
>>> svd_factor_matrix
SVDFactorMatrix(field='author_keywords', shape=(20, 2))
