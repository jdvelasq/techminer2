...
>>> factor_matrix = techminer2plus.factor_matrix_pca(
...     cooc_matrix,
... )
>>> factor_matrix
FactorMatrixPCA(field='author_keywords', shape=(20, 20))
...
from .matrix.co_occurrence_matrix.matrix_normalization import (
    matrix_normalization,
)


@dataclass
class FactorMatrixPCA:
    """PCA factor matrix."""
