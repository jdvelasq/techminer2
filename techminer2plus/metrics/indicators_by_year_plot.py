...
>>> file_name = "sphinx/_static/metrics/time_plot.html"
>>> import techminer2plus
>>> indicators = techminer2plus.metrics.indicators_by_year(root_dir)
...
.. raw:: html
    ...
    <iframe src="../../../_static/metrics/time_plot.html" height="600px" width="100%" 
