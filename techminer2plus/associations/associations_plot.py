...
...    root_dir=ROOT_DIR,
... )
>>> file_name = "sphinx/_static/associations/associations_plot.html"
>>> chart = techminer2plus.associations.associations_plot(item="REGTECH", cooc_matrix=cooc_matrix)
>>> chart.plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../_static/associations/associations_plot.html" 
