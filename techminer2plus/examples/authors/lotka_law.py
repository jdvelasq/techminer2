...
>>> file_name = "sphinx/_static/examples/authors/lotka_law.html"

>>> import techminer2plus
>>> techminer2plus.examples.authors.lotka_law(root_dir=root_dir).plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../_static/examples/authors/lotka_law.html" height="600px" width="100%" frameBorder="0"></iframe>


>>> techminer2plus.examples.authors.lotka_law(root_dir=root_dir).table_
