...
>>> file_name = "sphinx/_static/examples/organizations/most_frequent_organizations.html"

>>> import techminer2plus
>>> r = techminer2plus.examples.organizations.most_frequent_organizations(
...     root_dir=root_dir,
...     top_n=20,
... )
...
.. raw:: html
    ...
    <iframe src="../../../_static/examples/organizations/most_frequent_organizations.html" height="600px" width="100%" frameBorder="0"></iframe>

    
>>> r.table_.head()
organizations
Univ of Hong Kong (HKG)      3
Univ Coll Cork (IRL)         3
Ahlia Univ (BHR)             3
Coventry Univ (GBR)          2
...
| Politec di Milano (ITA)                                            |     2 |             1 |                   1 |                  2 |                 0 |                            1    |                           0    |                   0   |                     0.5 |                    0.25     |                     2020 |     4 |                        0.5  |         1 |         1 |      0.25 |
