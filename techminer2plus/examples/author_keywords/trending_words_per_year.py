...
>>> file_name = "sphinx/_static/examples/author_keywords/trending_words_per_year.html"

>>> import techminer2plus
>>> techminer2plus.examples.author_keywords.trending_words_per_year(
...     root_dir=root_dir, 
... ).table_.head(20)
...
.. raw:: html
    ...
    <iframe src="../../../../_static/examples/author_keywords/trending_words_per_year.html" height="900px" width="100%" frameBorder="0"></iframe>
