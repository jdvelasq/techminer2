...
>>> techminer2plus.examples.cited_references.rpys(root_dir=root_dir).plot_.write_html(file_name)
...
>>> techminer2plus.examples.cited_references.rpys(root_dir=root_dir).table_.head()
