...
>>> nnet = techminer2plus.examples.conceptual_structure.thematic_map.descriptors(
...     top_n=20,
...     root_dir=root_dir,
...     algorithm_or_estimator="louvain",
...     network_viewer_dict={'nx_k': 0.2, 'nx_iterations': 10},
... )
--INFO-- The file 'data/regtech/reports/reports/thematic_map/descriptors/CL_00_abstracts_report.txt' was created.
--INFO-- The file 'data/regtech/reports/reports/thematic_map/descriptors/CL_01_abstracts_report.txt' was created.
--INFO-- The file 'data/regtech/reports/reports/thematic_map/descriptors/CL_00_prompt.txt' was created.
--INFO-- The file 'data/regtech/reports/reports/thematic_map/descriptors/CL_01_prompt.txt' was created.


>>> file_name = "sphinx/_static/examples/conceptual_structure/thematic_map/descriptors.html"
>>> nnet.plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../../../_static/examples/conceptual_structure/thematic_map/descriptors.html" height="600px" width="100%" frameBorder="0"></iframe>
...
>>> file_name = "sphinx/_static/examples/conceptual_structure/thematic_map/descriptors_degree_plot.html"
>>> nnet.degree_plot__plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../../../_static/examples/thematic_map/descriptors_degree_plot.html" height="600px" width="100%" frameBorder="0"></iframe>
...
FIELD = "descriptors"
REPORT_DIR = "reports/thematic_map/descriptors/"
