...
>>> nnet = techminer2plus.examples.social_structure.countries_collaboration_network(
...     top_n=20,
...     root_dir=root_dir,
...     algorithm="louvain",
...
>>> file_name = "sphinx/_static/examples/countries_collaboration_network_plot.html"
>>> nnet.plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../../_static/examples/countries_collaboration_network_plot.html" height="600px" width="100%" frameBorder="0"></iframe>
...
>>> file_name = "sphinx/_static/examples/countries_collaboration_network_degree_plot.html"
>>> nnet.degree_plot__plot_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../../_static/examples/countries_collaboration_network_degree_plot.html" height="600px" width="100%" frameBorder="0"></iframe>
