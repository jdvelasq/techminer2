...
>>> file_name = "sphinx/_static/examples/documents/most_local_cited_documents.html"

>>> import techminer2plus
>>> r = techminer2plus.examples.documents.most_local_cited_documents(
...     top_n=20,
...     root_dir=root_dir,
... )
--INFO-- The file 'data/regtech/reports/most_local_cited_documents__abstracts.txt' was created.
--INFO-- The file 'data/regtech/reports/most_local_cited_documents__gpt_prompt.txt' was created.
...
.. raw:: html
    ...
    <iframe src="../../../_static/examples/documents/most_local_cited_documents.html" height="600px" width="100%" frameBorder="0"></iframe>
