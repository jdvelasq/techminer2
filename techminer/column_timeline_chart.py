...
>>> column_timeline_chart('authors', min_occ=2, directory=directory).savefig(file_name)

.. image:: images/column_timeline_chart.png
    :width: 700px
    :align: center

>>> column_timeline_chart('authors', min_occ=2, directory=directory, plot=False).head()
