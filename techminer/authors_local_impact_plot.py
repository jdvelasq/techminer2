...
>>> file_name = "/workspaces/techminer-api/sphinx/images/author_local_impact_plot.png"
>>> authors_local_impact_plot(n_authors=20, directory=directory).savefig(file_name)
