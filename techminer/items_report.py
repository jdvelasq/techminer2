...
def _count_citations_by_item(directory, column, sep, citations_column):
    """
...
def count_documents_by_item(directory, column, sep):
    """
...
def count_global_citations_by_item(directory, column, sep="; "):
    """
    ...
    return _count_citations_by_item(directory, column, sep, "global_citations")


def count_local_citations_by_item(directory, column, sep="; "):
    """
    ...
    """
    return _count_citations_by_item(directory, column, sep, "local_citations")


def items_report(directory, column, sep="; "):
    """
    ...
    num_documents = count_documents_by_item(directory, column, sep).to_frame()
    global_citations = count_global_citations_by_item(directory, column, sep).to_frame()
    local_citations = count_local_citations_by_item(directory, column, sep).to_frame()
