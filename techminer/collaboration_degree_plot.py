...
>>> file_name = "/workspaces/techminer-api/sphinx/images/collaboration_degree_plot.png"
>>> collaboration_degree_plot('authors', min_occ=2, directory=directory).savefig(file_name)

.. image:: images/collaboration_degree_plot.png
    :width: 700px
    :align: center
