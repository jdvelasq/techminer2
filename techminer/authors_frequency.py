...
>>> file_name = "/workspaces/techminer-api/sphinx/images/authors_frequency.png"
>>> authors_frequency(directory=directory).savefig(file_name)

.. image:: images/authors_frequency.png
    :width: 650px
    :align: center


>>> authors_frequency(directory=directory, plot=False).head()
...
>>> authors_frequency(directory=directory, use_frac_num_documents=True, plot=False).head()
            num_documents  frac_num_documents
authors                                      
Wojcik D                5                 3.2
Serrano W               2                 2.0
