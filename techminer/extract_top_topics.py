...
>>> file_name = "/workspaces/techminer-api/sphinx/images/extract_top_topics.png"
>>> extract_top_topics(column="authors", directory=directory).savefig(file_name)

.. image:: images/extract_top_topics.png
    :width: 700px
    :align: center


>>> extract_top_topics(column='authors', directory=directory, plot=False).head()
