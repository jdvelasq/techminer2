...
>>> file_name = "/workspaces/techminer-api/sphinx/images/countries_frequency.png"
>>> countries_frequency(directory=directory).savefig(file_name)
 
.. image:: images/countries_frequency.png
    :width: 650px
    :align: center
