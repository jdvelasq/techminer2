...
>>> file_name = "/workspaces/techminer-api/sphinx/images/column_bar_chart.png"
>>> column_bar_chart('author_keywords', 15, directory=directory).savefig(file_name)

.. image:: images/column_bar_chart.png
    :width: 700px
    :align: center


>>> column_bar_chart('author_keywords', 15, directory=directory, plot=False).head()
