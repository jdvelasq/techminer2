...
>>> file_name = "/workspaces/techminer-api/sphinx/images/authors_collaboration_network.png"
>>> authors_collaboration_network(directory=directory).savefig(file_name)

.. image:: images/authors_collaboration_network.png
    :width: 550px
    :align: center
