...
#     thesaurus_file = os.path.join(
#         directory, "processed", "author_keywords.txt"
#     )
...
#             data = data.assign(
#                 author_keywords=data.raw_author_keywords.str.split(";")
#             )
#             data = data.assign(
...
#             )
#             data = data.assign(
#                 author_keywords=data.author_keywords.str.join("; ")
#             )
