...
>>> from techminer2.agenda.network.author_keywords import degree_plot
>>> plot = degree_plot(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... )
>>> plot.fig_.write_html("sphinx/_static/agenda/network/author_keywords/degree_plot.html")

.. raw:: html

    <iframe src="../../../../_static/agenda/network/author_keywords/degree_plot.html" 
    height="600px" width="100%" frameBorder="0"></iframe>

>>> plot.df_.head()
   Node                         Name  Degree
0     0  FINANCIAL_REGULATION 04:035       3
1     1             REPORTING 02:001       3
2     2               FINANCE 02:001       2
3     3               SUPTECH 03:004       1
4     4       DATA_PROTECTION 02:027       1
...
|  3 |      3 | SUPTECH 03:004              |        1 |
|  4 |      4 | DATA_PROTECTION 02:027      |        1 |
|  5 |      5 | CHARITYTECH 02:017          |        1 |
|  6 |      6 | ENGLISH_LAW 02:017          |        1 |
|  7 |      7 | TECHNOLOGY 02:010           |        0 |
```
<BLANKLINE>
