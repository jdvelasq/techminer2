...
>>> from techminer2.agenda.network.index_keywords import communities_summary
>>> communities_summary(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  FINANCIAL_CRISIS; REGULATORY_FRAMEWORK; TECHNO...
1    CL_1  ...  FINANCIAL_REGULATION; REGULATORY_REQUIREMENTS;...
2    CL_2  ...  FINANCIAL_SERVICES_INDUSTRY; CLASSIFICATION (O...
<BLANKLINE>
[3 rows x 4 columns]
