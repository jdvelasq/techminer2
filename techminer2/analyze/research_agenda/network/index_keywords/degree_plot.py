...
>>> from techminer2.agenda.network.index_keywords import degree_plot
>>> plot = degree_plot(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... )
>>> plot.fig_.write_html("sphinx/_static/agenda/network/index_keywords/degree_plot.html")

.. raw:: html

    <iframe src="../../../../_static/agenda/network/index_keywords/degree_plot.html" 
    height="600px" width="100%" frameBorder="0"></iframe>

>>> plot.df_.head()
   Node                          Name  Degree
0     0  GLOBAL_FINANCIAL_CRISIS 2:00       6
1     1     REGULATORY_FRAMEWORK 2:02       5
2     2  TECHNOLOGICAL_SOLUTIONS 2:02       5
3     3    REGULATORY_TECHNOLOGY 2:01       5
4     4         FINANCIAL_CRISIS 2:07       4
...
|  3 |      3 | REGULATORY_TECHNOLOGY 2:01           |        5 |
|  4 |      4 | FINANCIAL_CRISIS 2:07                |        4 |
|  5 |      5 | REGULATORY_REQUIREMENTS 2:02         |        4 |
|  6 |      6 | FINANCIAL_REGULATION 2:11            |        3 |
|  7 |      7 | FINANCIAL_SERVICES_INDUSTRY 2:11     |        2 |
|  8 |      8 | CLASSIFICATION (OF_INFORMATION) 2:03 |        2 |
|  9 |      9 | ARTIFICIAL_INTELLIGENCE 2:02         |        2 |
```
<BLANKLINE>
