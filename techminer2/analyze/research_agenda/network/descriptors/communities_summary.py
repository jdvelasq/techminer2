...
>>> from techminer2.agenda.network.descriptors import communities_summary
>>> communities_summary(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  GLOBAL_FINANCIAL_CRISIS; DIGITAL_INNOVATION; F...
1    CL_1  ...  MACHINE_LEARNING; REGULATION_TECHNOLOGY; PRIMA...
2    CL_2  ...  CHARITYTECH; ENGLISH_LAW; INTERNATIONAL_REGULA...
3    CL_3  ...  REGULATORY_FRAMEWORK; REGULATORY_APPROACHES; N...
4    CL_4  ...                                     FINTECH_SECTOR
<BLANKLINE>
[5 rows x 4 columns]
