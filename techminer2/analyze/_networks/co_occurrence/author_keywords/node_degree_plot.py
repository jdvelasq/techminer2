...
Smoke tests:
    ...
    >>> # CODE TESTED
    >>> #
    >>> from techminer2.co_occurrence_network.author_keywords import NodeDegreePlot
    >>> plot = (
    ...     NodeDegreePlot()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.co_occurrence.author_keywords.node_degree_plot.html")

.. raw:: html

    <iframe src="../_generated/px.packages.networks.co_occurrence.author_keywords.node_degree_plot.html"
