...
from techminer2.analyze._factor_analysis.co_occurrence.terms_by_dimension_data_frame import (
    terms_by_dimension_frame,
)
from techminer2.analyze._factor_analysis.co_occurrence.terms_to_cluster_mapping import (
