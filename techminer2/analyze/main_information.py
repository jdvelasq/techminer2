...
>>> from techminer2.analyze import main_information
>>> info = main_information(
...     #
...     # DATABASE PARAMS:
...
>>> info.fig_.write_html("sphinx/_static/analyze/main_information_dashboard.html")

.. raw:: html

    <iframe src="../../../../_static/analyze/main_information_dashboard.html"
...
from ._main_information_dashboard import main_information_dashboard
from ._main_information_prompt import main_information_prompt
from ._main_information_table import main_information_table
...
def main_information(
    ...
    **filters,
    ...
    prompt = main_information_prompt(data_frame)
    fig = main_information_dashboard(data_frame)
