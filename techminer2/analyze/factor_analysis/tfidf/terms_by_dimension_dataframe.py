...
## ...     random_state=0,
## ... )
## >>> from techminer2.packages.factor_analysis.tfidf import terms_by_dimension_frame
## >>> (
...
from techminer2.analyze.tfidf.data_frame import DataFrame as TfIdfDataFrame
