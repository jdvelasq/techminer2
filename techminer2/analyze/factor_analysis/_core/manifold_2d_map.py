...
from ....internals.helpers.helper_compute_textposition_from_x_and_y import (
    helper_compute_textposition_from_x_and_y,
)
...
def manifold_2d_map(
    ...
    textpositions = helper_compute_textposition_from_x_and_y(node_x, node_y)
