...
>>> from techminer2.analyze.co_occurrences import ego_network
>>> ego_network(
...
... ).write_html("sphinx/_static/analyze/co_occurrences/ego_network.html")

.. raw:: html

    <iframe src="../../../../../_static/analyze/co_occurrences/ego_network.html" 
...
from ...co_occurrence_analysis.visualization.matrix_viewer import matrix_viewer
...
def ego_network(
    ...
    **filters,
    ...
    """Generates a co-occurrence network.
