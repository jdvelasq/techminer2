...
>>> from techminer2.analyze.co_occurrence.network.nlp_phrases import communities_summary
>>> communities_summary(
...     #
...     # SUMMARY PARAMS:
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  FINANCIAL_INSTITUTIONS; FINANCIAL_REGULATION; ...
1    CL_1  ...  REGULATORY_TECHNOLOGY; FINANCIAL_SECTOR; ARTIF...
2    CL_2  ...  FINANCIAL_SYSTEM; REGTECH; FINANCIAL_SERVICES_...
<BLANKLINE>
[3 rows x 4 columns]
