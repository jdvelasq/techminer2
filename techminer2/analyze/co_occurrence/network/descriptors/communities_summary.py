...
>>> from techminer2.analyze.co_occurrence.network.descriptors import communities_summary
>>> communities_summary(
...     #
...     # SUMMARY PARAMS:
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  FINANCIAL_INSTITUTIONS; NEW_TECHNOLOGIES; FINA...
1    CL_1  ...  REGTECH; REGULATORY_COMPLIANCE; FINTECH; COMPL...
