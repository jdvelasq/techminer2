...
Smoke tests:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docs_source/_generated/px.packages.correlation.auto.network_map_plot.html")
...
from techminer2.analyze._metrics.correlation.auto.matrix_data_frame import (
    MatrixDataFrame,
)
