...
Smoke tests:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.associations.butterfly_plot.html")

.. raw:: html

    <iframe src="../_generated/px.packages.associations/butterfly_plot.html"
...
from techminer2.analyze._metrics.associations.dataframe import DataFrame
