        ...
        for index in data_right.index:
            for col in data_right.columns:
                ...
                if data_right.loc[index, col] > 0:
                    ...
                    middle_base__ += data_right.loc[index, col]

            middle_base__ += params["space"]
