...
Smoke tests:
    ...
    >>> from techminer2.refine.thesaurus_old.descriptors import InitializeThesaurus, SortByLastWords
...
from techminer2.refine.thesaurus_old.user import SortByLastWords as UserSortByLastWords
