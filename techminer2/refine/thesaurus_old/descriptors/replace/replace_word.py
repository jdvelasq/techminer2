...
Smoke tests:
    ...
    >>> from techminer2.refine.thesaurus_old.descriptors import InitializeThesaurus, ReplaceWord
...
from techminer2.refine.thesaurus_old.user import ReplaceWord as UserReplaceWord
