...
def apply_startswith_rule(
    ...
    statswith_df = thesaurus_df[
        thesaurus_df[PREFERRED].str.startswith(params.pattern)
    ].copy()

    candidates_0_df = statswith_df[statswith_df["word_count"] == 1].copy()
    ...
    candidates_1_df = statswith_df[statswith_df["word_count"] >= 2].copy()
