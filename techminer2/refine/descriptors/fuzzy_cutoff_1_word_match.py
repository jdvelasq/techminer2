...
Smoke test:
    ...
    >>> from techminer2.refine.descriptors.fuzzy_cutoff_1_word_match import FuzzyCutoffOneWordMatch
    >>> (
    ...     FuzzyCutoffOneWordMatch()
    ...     .using_colored_output(False)
...
from techminer2.refine._internals.rules import apply_fuzzy_cutoff_1_word_rule
