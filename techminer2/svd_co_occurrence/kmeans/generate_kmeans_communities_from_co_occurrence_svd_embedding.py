...
>>> from techminer2.tech_mining.svd.cooc_matrix.kmeans import communities
>>> communities(
...     #
...     # PARAMS:
...     field="nlp_phrases",
...
... ).head()
                         CL_0  ...                          CL_5
0             BANKING 14:1848  ...  FINANCIAL_TECHNOLOGY 17:2225
1          INNOVATION 13:2298  ...                              
2               PAPER 12:1700  ...                              
3  FINANCIAL_SERVICES 11:2191  ...                              
4             RESULTS 11:1810  ...                              
<BLANKLINE>
[5 rows x 6 columns]
...
def generate_kmeans_communities_from_co_occurrence_svd_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
