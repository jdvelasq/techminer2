...
def _replace_descriptors(root_dir):
    ...
    def replace_hypen_by_space_in_title_column():
        ...
        documents["document_title"] = documents["document_title"].astype(str).apply(lambda x: x.translate(str.maketrans("_", " ")))
        #
    ...
    def replace_hypen_by_space_in_abstract_column(root_dir):
        ...
        documents["abstract"] = documents["abstract"].astype(str).apply(lambda x: x.translate(str.maketrans("_", " ")))
        #
        documents.to_csv(documents_path, index=False, compression="zip")
