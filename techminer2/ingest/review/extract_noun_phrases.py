...
Smoke test:
    >>> from techminer2.ingest.review import ExtractNounPhrases
    >>> (
    ...     ExtractNounPhrases()
...
class ExtractNounPhrases(
    ...
    def _build_steps(self) -> list[Step]:
        ...
        from techminer2.ingest.sources._internals.words_and_np.extract_abstract_phrases import (
            extract_abstract_phrases,
        )
        from techminer2.ingest.sources._internals.words_and_np.extract_title_phrases import (
            extract_title_phrases,
        )
        from techminer2.ingest.sources._internals.words_and_np.merge_keywords_phrases import (
            merge_keywords_phrases,
        )
        from techminer2.ingest.sources._internals.words_and_np.merge_title_abstract_phrases import (
            merge_title_abstract_phrases,
        )
        from techminer2.ingest.sources._internals.words_and_np.uppercase_abstract_phrases import (
            uppercase_abstract_phrases,
        )
        from techminer2.ingest.sources._internals.words_and_np.uppercase_title_phrases import (
