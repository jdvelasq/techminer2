...
def replace_journal_name_in_references(root_dir):
    ...
    for source, abbr_source_title in tqdm(zip(abbrs.source, abbrs.abbr_source_title), total=len(abbrs)):
        main["raw_global_references"] = main["raw_global_references"].str.replace(source, abbr_source_title, regex=False)
