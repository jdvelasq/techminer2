...
def add_country_code_column(frame, root_dir):
    ...
    countries = {}
    #
    file_path = pkg_resources.resource_filename("techminer2", "thesaurus/_data/country-to-alpha3.the.txt")
...
def replace_abbreviations(frame, root_dir):
    ...
    abbr_dict = {}
    file_path = pkg_resources.resource_filename("techminer2", "thesaurus/_data/organizations_abbr.the.txt")
