...
... ).write_html("sphinx/_static/analyze/co_citation/cited_references/item_density_visualization.html")

.. raw:: html

    <iframe src="../../../../../_static/analyze/co_citation/cited_references/item_density_visualization.html" 
...
def plot_node_density_from_cited_references_network(
    #
    # COLUMN PARAMS:
    top_n=None,
    citations_threshold=None,
