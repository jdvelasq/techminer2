...
"""
from ...co_occurrence_matrix.plot_network_from_co_occurrence_matrix import plot_network_from_co_occurrence_matrix
...
def word_network(
    ...
    **filters,
    ...
    #
    # Returb the network
    return plot_network_from_co_occurrence_matrix(
        #
        # FUNCTION PARAMS:
        columns=columns,
        rows=rows,
