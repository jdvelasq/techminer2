...
>>> from techminer2.tech_mining.svd.tfidf_matrix.hierarchical import to_brute_force_labels
...
... )  # doctest: +ELLIPSIS
{'FINANCIAL_INDUSTRY 17:3704': 0, 'INNOVATION 13:2298': 0, 'FINANCIAL_SERVICES 11:2191': 0, ...
...
def map_tfidf_svd_terms_to_hierarchical_clusters(
    #
    # PARAMS:
    field,
    #
