...
>>> from techminer2.tech_mining.svd.tfidf_matrix.brute_force import factor_map
>>> factor_map(
...     #  
...     # PARAMS:
...
... ).write_html("sphinx/_static/analyze/svd/tfidf_matrix/kmeans/factor_map.html")

.. raw:: html

    <iframe src="../../../../_static/analyze/svd/tfidf_matrix/kmeans/factor_map.html"
...
from .compute_user_cluster_centers_from_tfidf_svd_embedding import compute_user_cluster_centers_from_tfidf_svd_embedding
from .generate_user_communities_from_tfidf_svd_embedding import generate_user_communities_from_tfidf_svd_embedding


def plot_user_factor_map_from_tfidf_svd_embedding(
    #
    # PARAMS:
    field,
    #
    ...
    **filters,
    ...
    centers = compute_user_cluster_centers_from_tfidf_svd_embedding(
        #
        # PARAMS:
        field=field,
        #
    ...
    members = generate_user_communities_from_tfidf_svd_embedding(
        #
        # PARAMS:
        field=field,
        #
