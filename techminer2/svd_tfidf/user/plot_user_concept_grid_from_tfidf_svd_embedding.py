...
>>> from techminer2.tech_mining.svd.tfidf_matrix.brute_force import concept_grid
>>> concept_grid(
...     #  
...     # PARAMS:
...
... ).render("sphinx/images/analyze/svd/tfidf_matrix/kmeans/concept_grid", format="png")
'sphinx/images/analyze/svd/tfidf_matrix/kmeans/concept_grid.png'

.. image:: /images/analyze/svd/tfidf_matrix/kmeans/concept_grid.png
    :width: 900px
    :align: center
...
def plot_user_concept_grid_from_tfidf_svd_embedding(
    #
    # PARAMS:
    field,
    #
