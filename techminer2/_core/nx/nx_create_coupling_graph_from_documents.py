...
from .nx_assign_opacity_to_text_based_on_degree import nx_assign_opacity_to_text_based_on_degree
from .nx_assign_sizes_to_nodes_based_on_citations import nx_assign_sizes_to_nodes_based_on_citations
from .nx_assign_sizes_to_nodes_based_on_degree import nx_assign_sizes_to_nodes_based_on_degree
...
def nx_create_coupling_graph_from_documents(
    #
    # COLUMN PARAMS:
    top_n=None,
