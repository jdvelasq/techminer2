...
Example:
    ...
    >>> from techminer2.thesaurus_old.organizations import InitializeThesaurus, SortByMatch
...
from techminer2.thesaurus_old.user import SortByMatch as UserSortByMatch
