...
Example:
    ...
    >>> from techminer2.thesaurus_old.organizations import InitializeThesaurus, SortByFuzzyMatch
...
from techminer2.thesaurus_old.user import SortByFuzzyMatch as UserSortByFuzzyMatch
