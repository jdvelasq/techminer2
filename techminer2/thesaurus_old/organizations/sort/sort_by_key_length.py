...
Example:
    ...
    >>> from techminer2.thesaurus_old.organizations import InitializeThesaurus, SortByKeyLength
...
from techminer2.thesaurus_old.user import SortByKeyLength as UserSortByKeyLength
