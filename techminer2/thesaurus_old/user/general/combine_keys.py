...
Smoke tests:
    >>> from techminer2.thesaurus_old.user import InitializeThesaurus
    >>> (
    ...     InitializeThesaurus()
    ...
    >>> from techminer2.thesaurus_old.user import ApplyThesaurus
    >>> (
    ...     ApplyThesaurus()
    ...     .with_thesaurus_file("demo.the.txt")
    ...     .with_field("raw_descriptors")
    ...
    >>> from techminer2.thesaurus_old.user import CombineKeys
    >>> df = (
    ...     CombineKeys()
    ...     #
    ...     # FIELD:
...
from techminer2.metrics.co_occurrence_matrix import DataFrame as CoocDataFrame
