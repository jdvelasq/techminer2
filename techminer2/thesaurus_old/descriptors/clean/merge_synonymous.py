...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, MergeSynonymous
...
class MergeSynonymous(
    ...
    def run(self):
        ...
        from techminer2.thesaurus_old.descriptors import AreSynonymous, MergeKeys
