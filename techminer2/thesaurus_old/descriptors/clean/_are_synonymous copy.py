...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, AreSynonymous
...
class AreSynonymous(
    ...
    def internal__evaluate_merging(self):
        ...
        from techminer2.thesaurus_old.descriptors import GetContexts
        ...
        self.system_prompt = internal__load_template(
            "shell.thesaurus.descriptors.clean.synonyms.system.txt"
        )
        self.user_template = internal__load_template(
