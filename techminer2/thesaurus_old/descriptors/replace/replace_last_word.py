...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, ReplaceLastWord
...
from techminer2.thesaurus_old.user import ReplaceLastWord as UserReplaceEndsWithWord
