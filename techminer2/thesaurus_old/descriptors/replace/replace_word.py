...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, ReplaceWord
...
from techminer2.thesaurus_old.user import ReplaceWord as UserReplaceWord
