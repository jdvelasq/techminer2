...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, SortByOccurrences
...
from techminer2.thesaurus_old.user import SortByOccurrences as UserSortByOccurrences
