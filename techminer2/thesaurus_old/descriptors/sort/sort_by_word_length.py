...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, SortByWordLength
...
from techminer2.thesaurus_old.user import SortByWordLength as UserSortByWordLength
