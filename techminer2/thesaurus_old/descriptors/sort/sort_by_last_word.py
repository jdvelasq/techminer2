...
Example:
    ...
    >>> from techminer2.thesaurus_old.descriptors import InitializeThesaurus, SortByLastWords
...
from techminer2.thesaurus_old.user import SortByLastWords as UserSortByLastWords
