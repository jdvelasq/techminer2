...
"""
.. _tm2.performnance.overview.cumulative_publications_per_year:

Cumulative Publications per Year
===============================================================================

>>> from techminer2.performance.overview import cumulative_publications_per_year
>>> chart = cumulative_publications_per_year(
...     #
...     # CHART PARAMS:
...     title="Cumulative Publications per Year",
...     year_label=None,
...     metric_label="Cumulative Publications per Year",
...     textfont_size=10,
...     marker_size=7,
...     line_width=1.5,
...     yshift=4,
...
>>> file_name = "sphinx/_static/performance/overview/cumulative_publications_per_year.html"
>>> chart.fig_.write_html(file_name)

.. raw:: html

    <iframe src="../../../../../_static/performance/overview/cumulative_publications_per_year.html" 
...
def cumulative_publications_per_year(
    #
    # CHART PARAMS:
    title: str = "Cumulative Publications per Year",
    year_label=None,
    metric_label="Cumulative Publications per Year",
    textfont_size=10,
    marker_size=7,
