...
"""
.. _tm2.performance.overview.global_citations_per_year:

Global Citations per Year
===============================================================================


>>> from techminer2.performance.overview import global_citations_per_year
>>> chart = global_citations_per_year(
...     #
...     # CHART PARAMS:
...     title="Global Citations per Year",
...     metric_label="Global Citations per Year",
...     year_label=None,
...     textfont_size=10,
...     marker_size=7,
...     line_width=1.5,
...
... )
>>> chart.fig_.write_html("sphinx/_static/performance/overview/global_citations_per_year.html")

.. raw:: html

    <iframe src="../../../../../_static/performance/overview/global_citations_per_year.html"  
...
def global_citations_per_year(
    ...
    **filters,
    ...
    fig = plot_metrics_by_year(
        indicator_to_plot="global_citations",
        auxiliary_indicator="local_citations",
        #
        # CHART PARAMS:
        title=title,
