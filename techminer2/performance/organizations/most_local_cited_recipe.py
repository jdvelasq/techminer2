...
>>> items.fig_.write_html("sphinx/_static/performance/organizations/most_local_cited_chart.html")

.. raw:: html

    <iframe src="../../../../_static/performance/organizations/most_local_cited_chart.html" height="600px" width="100%" frameBorder="0"></iframe>
