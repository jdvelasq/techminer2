...
>>> from techminer2.tech_mining.pca.cooc_matrix.hierarchical import cluster_centers
>>> cluster_centers(
...     #
...     # PARAMS:
...
LABELS                                                   
CL_0    -1.707400 -0.936735 -0.926549 -1.082089  0.149149
CL_1    -1.221035  0.431891 -0.868879  1.458011  0.604680
CL_2    -2.946313  2.081332  0.432782 -0.273888 -1.051393
...
def compute_hierachical_cluster_centers_from_co_occurrence_pca_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
