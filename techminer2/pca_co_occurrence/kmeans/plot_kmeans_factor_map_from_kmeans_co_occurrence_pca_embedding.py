...
>>> from techminer2.tech_mining.pca.cooc_matrix.kmeans import factor_map
>>> factor_map(
...     #
...     # PARAMS:
...
... ).write_html("sphinx/_static/analyze/pca/cooc_matrix/kmeans/factor_map.html")

.. raw:: html

    <iframe src="../../../../_static/analyze/pca/cooc_matrix/kmeans/factor_map.html"
...
from .compute_kmeans_cluster_centers_from_co_occurrence_pca_embedding import compute_kmeans_cluster_centers_from_co_occurrence_pca_embedding
...
def plot_kmeans_factor_map_from_kmeans_co_occurrence_pca_embedding(
    ...
    **filters,
    ...
    centers = generate_kmeans_communities_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
    ...
    members = generate_kmeans_communities_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
        association_index=association_index,
