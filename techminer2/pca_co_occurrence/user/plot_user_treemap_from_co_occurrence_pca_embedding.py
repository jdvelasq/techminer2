...
>>> from techminer2.tech_mining.pca.cooc_matrix.brute_force import treemap
>>> treemap(
...     #
...     # PARAMS:
...
... ).write_html("sphinx/_static/analyze/pca/cooc_matrix/brute_force/treemap.html")

.. raw:: html

    <iframe src="../../../../../../_static/analyze/pca/cooc_matrix/brute_force/treemap.html" 
...
def plot_user_treemap_from_co_occurrence_pca_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
