...
>>> from techminer2.tech_mining.pca.cooc_matrix.brute_force import concept_grid
>>> concept_grid(
...     #
...     # PARAMS:
...
... ).render("sphinx/images/analyze/pca/cooc_matrix/brute_force/concept_grid", format="png")
'sphinx/images/analyze/pca/cooc_matrix/brute_force/concept_grid.png'

.. image:: /images/analyze/pca/cooc_matrix/brute_force/concept_grid.png
    :width: 900px
    :align: center
...
def plot_user_concept_grid_from_co_occurrence_pca_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
