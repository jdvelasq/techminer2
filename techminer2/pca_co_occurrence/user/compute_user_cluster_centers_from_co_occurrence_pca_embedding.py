...
>>> from techminer2.tech_mining.pca.cooc_matrix.brute_force import cluster_centers
>>> cluster_centers(
...     #
...     # PARAMS:
...
LABELS                                                   
CL_0    -1.769506 -0.928760 -0.967392 -0.846595  0.067259
CL_1    -2.395520  1.972751  0.525795 -0.351139 -0.190105
CL_2    -1.320904 -2.582578  2.670715  0.533225 -0.480539
CL_3    -1.052596  0.461794 -1.298647  2.357028  0.378537
...
def compute_user_cluster_centers_from_co_occurrence_pca_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
