...
>>> directory = "data/"
>>> file_name = "/workspaces/techminer2/sphinx/images/_dotted_gantt_chart.png"
...
>>> _dotted_gantt_chart(data, color='grey', figsize=(8, 6)).savefig(file_name)

.. image:: images/_dotted_gantt_chart.png
    :width: 700px
    :align: center
...
def _dotted_gantt_chart(annual_occurrence_matrix, color="grey", figsize=(8, 6)):
