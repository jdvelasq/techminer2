...
>>> from techminer2.citation.network.organizations import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=30, 
...
... ).head()
                          CL_0                                               CL_1
0       Kingston Bus Sch (GBR)                                   Ahlia Univ (BHR)
1          Coventry Univ (GBR)                        FinTech HK, Hong Kong (HKG)
2    Univ of Westminster (GBR)                            Univ of Hong Kong (HKG)
3  Hebei Univ of Technol (CHN)  ctr for Law, Markets & Regulation, UNSW Austra...
4           Jiangsu Univ (CHN)                             Dublin City Univ (IRL)
