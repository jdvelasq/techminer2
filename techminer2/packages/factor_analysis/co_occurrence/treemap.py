...
## ...     .run()
## ... )
## >>> # plot.write_html("docs_src/_generated/packages/factor_analysis/co_occurrence/treemap.html")

.. raw:: html

    <iframe src="../../_generated/packages/factor_analysis/co_occurrence/treemap.html"
