...
## ...     .run()
## ... )
## >>> # plot.write_html("docs_src/_generated/packages/factor_analysis/tfidf/factor_map_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/factor_analysis/tfidf/factor_map_plot.html"
