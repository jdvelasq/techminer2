...
>>> from techminer2.packages.networks.citation.documents import NetworkPlot
>>> plot = (
...     NetworkPlot()
...     #
...     # UNIT OF ANALYSIS:
...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/citation/documents/network_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/citation/documents/network_plot.html"
