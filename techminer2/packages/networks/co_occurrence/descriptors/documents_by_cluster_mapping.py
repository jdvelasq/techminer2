...
Example:
    ...
    >>> #                           source_title_z_to_a
    >>> from techminer2.packages.networks.co_occurrence.descriptors import DocumentsByClusterMapping
...
from techminer2.packages.networks.co_occurrence.user.documents_by_cluster_mapping import (
