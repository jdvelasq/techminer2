...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/co_occurrence/author_keywords/treemap.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/co_occurrence/author_keywords/treemap.html"
