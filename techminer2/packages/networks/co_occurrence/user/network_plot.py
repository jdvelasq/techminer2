...
>>> from techminer2.packages.networks.co_occurrence.user import NetworkPlot
>>> plot = (
...     NetworkPlot()
...     #
...     # FIELD:
...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/co_occurrence/user/network_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/co_occurrence/user/network_plot.html"
