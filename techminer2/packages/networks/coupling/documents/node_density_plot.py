...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/coupling/documents/node_density_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/coupling/documents/node_density_plot.html"
