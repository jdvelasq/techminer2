...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/coupling/countries/node_degree_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/coupling/countries/node_degree_plot.html"
