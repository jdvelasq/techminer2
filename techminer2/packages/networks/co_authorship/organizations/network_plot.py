...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/co_authorship/organizations/network_plot.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/co_authorship/organizations/network_plot.html"
