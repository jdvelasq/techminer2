...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/co_authorship/organizations/treemap.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/co_authorship/organizations/treemap.html"
