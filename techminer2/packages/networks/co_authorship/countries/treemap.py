...
...     .run()
... )
>>> # plot.write_html("docs_src/_generated/packages/networks/co_authorship/countries/treemap.html")

.. raw:: html

    <iframe src="../../_generated/packages/networks/co_authorship/countries/treemap.html"
