...
>>> from techminer2.factor_analysis.tfidf import treemap
>>> plot = treemap(
...     #
...     # PARAMS:
...
... )
>>> # plot.write_html("sphinx/_static/factor_analysis/tfidf/treemap.html")

.. raw:: html

    <iframe src="../../_static/factor_analysis/tfidf/treemap.html" 
...
def treemap(
    ...
    **filters,
    ...
    name2color = {term: CLUSTER_COLORS[cluster] for term, cluster in c2t_mapping.items()}
