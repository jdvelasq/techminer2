...
>>> tm2p.most_relevant_sources_chart(
...    title="Most Relevant Sources",
...    top_n=20,
...    root_dir=root_dir,
... ).write_html("sphinx/_static/most_relevant_sources_chart.html")

.. raw:: html

    <iframe src="../../../../../_static/most_relevant_sources_chart.html" height="600px" width="100%" frameBorder="0"></iframe>
...
# pylint: disable=too-many-arguments
def most_relevant_sources_chart(
    #
    # ITEM FILTERS:
    top_n=None,
    #
