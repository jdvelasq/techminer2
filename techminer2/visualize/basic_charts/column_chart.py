...
>>> from techminer2.visualize.basic_charts.column_chart import ColumnChart
>>> plot = (
...     ColumnChart()
...     .set_item_params(
...
...     ).build(metric="OCC")
... )
>>> # plot.write_html("sphinx/_generated/visualize/basic_charts/column_chart.html")

.. raw:: html

    <iframe src="../../_generated/visualize/basic_charts/column_chart.html" 
