...
"""
Cleveland Dot Plot (MIGRATED)
===============================================================================

## >>> from techminer2.visualize.basic_plots.cleveland_dot_plot import ClevelandDotPlot
## >>> plot = (
## ...     ClevelandDotPlot()
## ...     .set_analysis_params(
## ...         metric="OCC",
...
## ...     ).build()
## ... )
## >>> plot.write_html("sphinx/_generated/visualize/basic_plots/cleveland_dot_plot.html")

.. raw:: html

    <iframe src="../../_generated/visualize/basic_plots/cleveland_dot_plot.html" 
...
class ClevelandDotPlot(
    ...
    def build(self):
        ...
        fig = self.build_cleveland_dot_plot(
            dataframe=dataframe, x_col=self.analysis_params.metric
        )
