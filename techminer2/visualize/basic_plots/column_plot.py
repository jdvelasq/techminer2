...
## ...     ).build()
## ... )
## >>> plot.write_html("sphinx/_generated/visualize/basic_plots/column_plot.html")

.. raw:: html

    <iframe src="../../_generated/visualize/basic_plots/column_plot.html" 
