...
>>> from techminer2.tech_mining.pca.tfidf_matrix.brute_force import factor_map
>>> factor_map(
...     #
...     # PARAMS:
...
def plot_factor_map_from_tfidf_pca_embedding(
    ...
    **filters,
    ...
    centers = compute_user_cluster_centers_from_tfidf_pca_embedding(
        #
        # PARAMS:
        field=field,
        #
    ...
    members = generate_user_communities_from_tfidf_pca_embedding(
        #
        # PARAMS:
        field=field,
        #
