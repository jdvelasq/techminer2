...
from techminer2.synthesize.conceptual_structure.factor_analysis._internals.terms_to_cluster_mapping import (
    _terms_to_cluster_mapping,
)
from techminer2.synthesize.conceptual_structure.factor_analysis.tfidf.terms_by_dimension_dataframe import (
