...
Smoke tests:
    ...
    >>> #                           source_title_z_to_a
    >>> from techminer2.co_occurrence_network.author_keywords import DocumentsByClusterMapping
...
from techminer2.synthesize.conceptual_structure.co_occurrence.usr.documents_by_cluster_mapping import (
