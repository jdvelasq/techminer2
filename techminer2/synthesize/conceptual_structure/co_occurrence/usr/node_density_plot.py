...
Smoke tests:
    >>> from techminer2.co_occurrence_network.user import NodeDensityPlot
    >>> plot = (
    ...     NodeDensityPlot()
    ...     #
    ...     # FIELD:
    ...
    ...     .run()
    ... )
    >>> plot.write_html("docsrc/_generated/px.packages.networks.co_occurrence.user.node_density_plot.html")

.. raw:: html

    <iframe src="../_generated/px.packages.networks.co_occurrence.user.node_density_plot.html"
...
from techminer2.synthesize.conceptual_structure.co_occurrence._internals.create_nx_graph import (
