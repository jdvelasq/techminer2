"""
Co-occurrence Network / Ego Graph
===============================================================================

>>> from techminer2 import *
>>> directory = "/workspaces/techminer2/data/"
>>> file_name = "/workspaces/techminer2/sphinx/images/co_occurrence_matrix_ego_graph.png"
...
.. image:: images/co_occurrence_matrix_ego_graph.png
    :width: 700px
    :align: center
...
def co_occurrence_matrix_ego_graph(
    topic,
    column,
    min_occ=1,
    directory="./",
    ...
    for i_row in range(len(matrix.index)):
        for i_col in range(len(matrix.columns)):
            if i_row == i_col:
                continue
            if columns[i_col] == topic:
                continue
            if indexes[i_row] == topic:
                continue
