...
>>> directory = "data/"
>>> file_name = "sphinx/images/_gantt_chart.png"
...
>>> _gantt_chart(data, color='tab:blue', figsize=(8, 6)).savefig(file_name)

.. image:: images/_gantt_chart.png
    :width: 700px
    :align: center
...
def _gantt_chart(annual_occurrence_matrix, color="tab:blue", figsize=(8, 6)):
