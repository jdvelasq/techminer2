...
>>> file_name = "/workspaces/techminer2/sphinx/images/co_occurrence_chord_diagram.png"
...
.. image:: images/co_occurrence_chord_diagram.png
    :width: 700px
    :align: center
...
def co_occurrence_chord_diagram(
    column,
    min_occ=1,
    max_terms=150,
    normalization=None,
