...
# from ....vosviewer.matrix_normalization import matrix_normalization
...
def mds_2d_map(
    ...
    **filters,
    ...
    node_occ = [int(text.split(" ")[-1].split(":")[0]) for text in matrix.index.to_list()]
