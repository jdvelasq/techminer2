...
"""
.. _most_relevant_organizations_prompt:

Most Relevant Organizations Prompt
===============================================================================

>>> root_dir = "data/regtech/"
>>> import techminer2 as tm2
>>> prompt = tm2p.most_relevant_organizations_prompt(
...    top_n=10,
...    root_dir=root_dir,
... )
>>> print(prompt)
...
the table below, sorted by the 'OCCGC' metric, and delimited by triple \\
...
def most_relevant_organizations_prompt(
    #
    # ITEM FILTERS:
    top_n=None,
    occ_range=(None, None),
