...
PY 2017
AB since decades, the FINANCIAL_INDUSTRY has experienced a CONTINUOUS_EVOLUTION
   in SERVICE_DELIVERY due to DIGITALIZATION. this EVOLUTION is characterized
   by expanded connectivity and enhanced SPEED of INFORMATION_PROCESSING both
   at the CUSTOMER_INTERFACE and in back_office PROCESSES. recently, there has
   been a shift in the focus of DIGITALIZATION from improving the DELIVERY of
   TRADITIONAL_TASKS to introducing fundamentally NEW_BUSINESS_OPPORTUNITIES
   and MODELS for FINANCIAL_SERVICE_COMPANIES. DIGITAL_FINANCE_ENCOMPASSES a
   magnitude of NEW_FINANCIAL_PRODUCTS, FINANCIAL_BUSINESSES, finance_related
   SOFTWARE, and NOVEL_FORMS of CUSTOMER_COMMUNICATION and interactiondelivered
   by FINTECH_COMPANIES and innovative FINANCIAL_SERVICE_PROVIDERS. against
   this backdrop, the RESEARCH on FINANCE and INFORMATION_SYSTEMS has started
   to analyze these changes and the impact of DIGITAL_PROGRESS on the
