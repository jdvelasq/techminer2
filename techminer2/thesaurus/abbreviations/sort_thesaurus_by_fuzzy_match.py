...
>>> from techminer2.thesaurus.abbreviations import SortThesaurusByFuzzyMatch
>>> (
...     SortThesaurusByFuzzyMatch()
...     # 
...     # THESAURUS:
...     .having_keys_like("UTM")
...
...     .build()
... ) 
--INFO-- The thesaurus file 'example/thesaurus/abbreviations.the.txt' has been rerodered.
...
class SortThesaurusByFuzzyMatch(
    ...
    def build(self):
        return (
            ...
            .with_thesaurus_file("abbreviations.the.txt")
            .build()
        )
