...
>>> from techminer2.thesaurus.abbreviations import SortThesaurusByKey
>>> (
...     SortThesaurusByKey()
...     # 
...     # THESAURUS:
...
...     .build()
... )
--INFO-- The thesaurus file 'examples/thesaurus/abbreviations.the.txt' has been ordered alphabetically.
