...
def merge_terms(
    ...
    if equals is not None:
        ...
        for secondary_term in startswith[1:]:
            #
            data_frame["key"] = data_frame["key"].str.replace(
        ...
        for secondary_term in endswith[1:]:
            #
            data_frame["key"] = data_frame["key"].str.replace(
        ...
        raise ValueError("You must specify one of the following parameters: equals, contains, startswith, endswith.")
    ...
    print(f"--INFO-- The keys in file {th_file} has been merged.")
