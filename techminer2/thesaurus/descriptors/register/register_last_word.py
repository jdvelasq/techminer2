...
Example:
    ...
    >>> from techminer2.thesaurus.descriptors import InitializeThesaurus, RegisterLastWord

    >>> # Redirecting stderr to avoid messages
    >>> original_stderr = sys.stderr
    >>> sys.stderr = StringIO()

    >>> # Register a new last word
    >>> (
    ...     RegisterLastWord()
    ...     .having_word("ABANDON")
    ...     .run()
...
class RegisterLastWord(
    ...
    def internal__register_new_word(self):
        ...
        data_path = "package_data/text_processing/data/common_last_words.txt"
