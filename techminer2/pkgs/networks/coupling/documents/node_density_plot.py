...
>>> from techminer2.pkgs.networks.coupling.documents import NodeDensityPlot
>>> plot = (
...     NodeDensityPlot()
...     #
...     # UNIT OF ANALYSIS:
...
...     .run()
... )
>>> # plot.write_html("sphinx/_generated/pkgs/networks/coupling/documents/node_density_plot.html")

.. raw:: html

    <iframe src="../../_generated/pkgs/networks/coupling/documents/node_density_plot.html" 
