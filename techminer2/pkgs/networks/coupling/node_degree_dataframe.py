...
"""
from .docs.node_degree_dataframe import _node_degree_frame as docs_node_degree_frame
from .others.node_degree_dataframe import _node_degree_frame as others_node_degree_frame
