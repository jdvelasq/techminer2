...
>>> from techminer2.pkgs.networks.citation.organizations import node_density_plot
>>> plot = (
...     NodeDensityPlot()
...     #
...     # UNIT OF ANALYSIS:
...
.. raw:: html
    ...
    <iframe src="../../_generated/pkgs/networks/citation/organizations/node_density_plot.html" 
