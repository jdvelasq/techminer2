...
>>> from techminer2.co_authorship.factor.pca.tfidf.authors import cosine_similarities
>>> cosine_similarities(
...     #
...     # TF PARAMS:
...     is_binary=True,
...
Butler T 2:041     OBrien L 1:033 (0.998); Arman AA 2:000 (0.956)...
Hamdan A 2:018          Turki M 2:018 (1.000); Sarea A 2:012 (0.996)
