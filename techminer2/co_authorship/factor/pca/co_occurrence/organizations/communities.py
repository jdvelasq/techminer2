...
>>> from techminer2.co_authorship.factor.pca.co_occurrence.organizations import communities
>>> communities(
...     #
...     # PARAMS:
...
... )
                                             CL_0  ... CL_5
0                   Univ of Hong Kong (HKG) 3:185  ...     
1                       Coventry Univ (GBR) 2:017  ...     
2                 Univ of Westminster (GBR) 2:017  ...     
