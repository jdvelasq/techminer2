...
>>> from techminer2.co_authorship.factor.pca.co_occurrence_matrix.organizations.hierarchical import communities
>>> communities(
...     #
...     # PARAMS:
...
... ).head()
                                                CL_0  ...                    CL_5
0                       Dublin City Univ (IRL) 2:014  ...  Ahlia Univ (BHR) 3:019
