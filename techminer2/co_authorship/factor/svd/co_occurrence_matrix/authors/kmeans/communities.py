...
>>> from techminer2.co_authorship.factor.svd.co_occurrence_matrix.authors.kmeans import communities
>>> communities(
...     #
...     # PARAMS:
...
... ).head()
                      CL_0             CL_1  ...           CL_4                CL_5
0           Butler T 2:041  Brennan R 2:014  ...    Lin W 2:017      Grassi L 2:002
1           Arman AA 2:000    Crane M 2:014  ...  Singh C 2:017  Lanfranchi D 2:002
