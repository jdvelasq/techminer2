...
>>> from techminer2.co_occurrence.factor.pca.co_occurrence_matrix.abstract_nlp_phrases.hierarchical import communities
>>> communities(
...     #
...     # PARAMS:
...
... ).head()
                       CL_0  ...                          CL_5
0   FINANCIAL_CRISIS 06:058  ...  REGULATORY_TECHNOLOGY 17:266
