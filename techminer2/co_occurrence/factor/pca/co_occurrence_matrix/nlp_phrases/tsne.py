...
>>> from techminer2.co_occurrence.factor.pca.co_occurrence_matrix.nlp_phrases import tsne
>>> tsne(
...     #
...     # PARAMS:
...
... ).write_html("sphinx/_static/co_occurrence/factor/pca/co_occurrence_matrix/nlp_phrases/tsne.html")
