...
>>> from techminer2.co_occurrence.factor.svd.tfidf.abstract_nlp_phrases.hierarchical import communities
>>> communities(
...     #
...     # TF PARAMS:
...     is_binary=True,
...
... ).head()
                       CL_0  ...                           CL_5
0   FINANCIAL_CRISIS 06:058  ...  FINANCIAL_INSTITUTIONS 15:194
