...
>>> from techminer2.co_occurrence.network.co_occurrence.keywords import communities_summary
>>> communities_summary(
...     #
...     # SUMMARY PARAMS:
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  REGTECH; FINTECH; COMPLIANCE; REGULATION; RISK...
1    CL_1  ...  REGULATORY_COMPLIANCE; FINANCE; FINANCIAL_INST...
2    CL_2  ...  REGULATORY_TECHNOLOGY; ANTI_MONEY_LAUNDERING; ...
<BLANKLINE>
[3 rows x 4 columns]
