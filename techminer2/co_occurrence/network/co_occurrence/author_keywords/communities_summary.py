...
>>> from techminer2.co_occurrence.network.co_occurrence.author_keywords import communities_summary
>>> communities_summary(
...     #
...     # SUMMARY PARAMS:
...
... )
  Cluster  ...                                              Terms
0    CL_0  ...  REGTECH; FINTECH; REGULATION; FINANCIAL_SERVIC...
1    CL_1  ...  REGULATORY_TECHNOLOGY; ANTI_MONEY_LAUNDERING; ...
2    CL_2  ...  COMPLIANCE; ACCOUNTABILITY; DATA_PROTECTION_OF...
<BLANKLINE>
[3 rows x 4 columns]
