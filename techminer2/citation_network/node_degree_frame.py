...
"""
from ._core.docs.node_degree_frame import _node_degree_frame as _node_degree_frame_from_docs
from ._core.others.node_degree_frame import _node_degree_frame as _node_degree_frame_from_others
