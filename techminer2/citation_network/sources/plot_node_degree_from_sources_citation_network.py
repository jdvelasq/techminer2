...
>>> from techminer2.science_mapping.citation.network.sources import degree_plot
>>> plot = degree_plot(
...     #
...     # COLUMN PARAMS:
...     top_n=30,
...
... )
>>> plot.fig_.write_html("sphinx/_static/analyze/citation/network/sources/degree_plot.html")

.. raw:: html

    <iframe src="../../../../../../_static/analyze/citation/network/sources/degree_plot.html" 
...
def plot_node_degree_from_sources_citation_network(
    #
    # COLUMN PARAMS:
    top_n=None,
