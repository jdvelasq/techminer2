...
... )
>>> plot.fig_.write_html("sphinx/_static/analyze/citation/network/organizations/degree_plot.html")

.. raw:: html

    <iframe src="../../../../../../_static/analyze/citation/network/organizations/degree_plot.html" 
    height="600px" width="100%" frameBorder="0"></iframe>

    
>>> plot.df_.head()
   Node                                               Name  Degree
0     0        Federal Reserve Bank of Chicago (USA) 2:253       2
1     1   Federal Reserve Bank of Philadelphia (USA) 3:317       2
2     2  Max Planck Inst. for Innovation and Competitio...       1
3     3                        Univ. of Zurich (CHE) 3:434       1
4     4                             Pace Univ. (USA) 2:323       1
...
def plot_node_degree_from_organizations_citation_network(
    #
    # COLUMN PARAMS:
    top_n=None,
