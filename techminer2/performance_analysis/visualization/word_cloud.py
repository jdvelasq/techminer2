...
>>> from techminer2.performance_analysis.visualization import word_cloud
>>> chart = word_cloud(
...     #
...     # ITEMS PARAMS:
...
... )
>>> chart.fig_.save("sphinx/_static/performance_analysis/visualization/word_cloud.png")

.. image:: ../../../_static/performance_analysis/visualization/word_cloud.png
    :width: 900px
    :align: center
