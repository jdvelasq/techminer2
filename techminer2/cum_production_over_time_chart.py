"""
Cumulative Production over Time Chart
===============================================================================

>>> from techminer2 import *
>>> directory = "data/"
>>> file_name = "sphinx/_static/cum_production_over_time_chart.html"
...
.. raw:: html
    ...
    <iframe src="_static/cum_production_over_time_chart.html" height="800px" width="100%" frameBorder="0"></iframe>
...
def cum_production_over_time_chart(
    column,
    top_n=5,
    directory="./",
    title=None,
    ...
    indicators_by_year = indicators_by_year.sort_values(
        by=[column.replace("_", " ").title(), "Year"], ascending=True
    )
