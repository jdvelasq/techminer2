...
>>> from techminer2.tech_mining.correlation import cross_correlation_map
...
def plot_map_from_cross_correlation_matrix(
    #
    # FUNCTION PARAMS:
    rows_and_columns,
    cross_with,
    ...
    **filters,
    ...
    corr_matrix = compute_cross_correlation_matrix(
        #
        # FUNCTION PARAMS:
