...
>>> from techminer2.tech_mining.svd.cooc_matrix.hierarchical import to_brute_force_labels
...
... )  # doctest: +ELLIPSIS
{'INNOVATION 13:2298': 0, 'FINANCIAL_SERVICES 11:2191': 0, 'RESULTS 11:1810': 0, ...

"""
from ...core.factor_analysis import FactorAnalyzer


def map_co_occurrence_svd_terms_to_hierarchical_clusters(
    #
    # PARAMS:
    field,
    association_index=None,
