...
>>> from techminer2.tech_mining.svd.cooc_matrix.brute_force import factor_map
>>> factor_map(
...     #
...     # PARAMS:
...
def plot_user_factor_map_from_co_occurrence_svd_embedding(
    ...
    **filters,
    ...
    centers = compute_user_cluster_centers_from_co_occurrence_svd_embedding(
        #
        # PARAMS:
        field=field,
    ...
    members = generate_user_communities_from_co_occurrence_svd_embedding(
        #
        # PARAMS:
        field=field,
        association_index=association_index,
