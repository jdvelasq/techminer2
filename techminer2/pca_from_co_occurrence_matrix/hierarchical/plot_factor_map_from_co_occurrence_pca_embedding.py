...
>>> from techminer2.tech_mining.pca.cooc_matrix.hierarchical import factor_map
>>> factor_map(
...     #
...     # PARAMS:
...
... ).write_html("sphinx/_static/analyze/pca/cooc_matrix/hierarchical/factor_map.html")

.. raw:: html

    <iframe src="../../../../_static/analyze/pca/cooc_matrix/hierarchical/factor_map.html"
...
def plot_factor_map_from_co_occurrence_pca_embedding(
    ...
    **filters,
    ...
    centers = compute_hierachical_cluster_centers_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
    ...
    members = generate_hierachical_communities_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
        association_index=association_index,
