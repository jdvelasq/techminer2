...
from .compute_user_cluster_centers_from_co_occurrence_pca_embedding import compute_user_cluster_centers_from_co_occurrence_pca_embedding
from .generate_user_communities_from_co_occurrence_pca_embedding import generate_user_communities_from_co_occurrence_pca_embedding


def plot_user_factor_map_from_co_occurrence_pca_embedding(
    #
    # PARAMS:
    field,
    association_index=None,
    ...
    **filters,
    ...
    centers = compute_user_cluster_centers_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
    ...
    members = generate_user_communities_from_co_occurrence_pca_embedding(
        #
        # PARAMS:
        field=field,
        association_index=association_index,
