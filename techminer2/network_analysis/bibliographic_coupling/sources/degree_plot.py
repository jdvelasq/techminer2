...
>>> from techminer2.network_analysis.bibliographic_coupling.sources import degree_plot
>>> plot = degree_plot(
...     #
...     # COLUMN PARAMS:
...     top_n=20, 
...
... )
>>> plot.fig_.write_html("sphinx/_static/network_analysis/bibliographic_coupling/sources/degree_plot.html")

.. raw:: html

    <iframe src="../../../../../../_static/network_analysis/bibliographic_coupling/sources/degree_plot.html" 
    height="600px" width="100%" frameBorder="0"></iframe>

    
>>> plot.df_.head()
   Node                           Name  Degree
0     0  INTELL SYST ACCOUNT FINANCE M       8
1     1                 J FINANC CRIME       8
2     2                        HELIYON       7
3     3                  J RISK FINANC       6
4     4             J ANTITRUST ENFORC       5
...
|  3 |      3 | J RISK FINANC                 |        6 |
|  4 |      4 | J ANTITRUST ENFORC            |        5 |
|  5 |      5 | J FINANCIAL DATA SCI          |        5 |
|  6 |      6 | FINANCIAL INNOV               |        4 |
|  7 |      7 | J BANK REGUL                  |        4 |
|  8 |      8 | J ECON BUS                    |        3 |
|  9 |      9 | ICEIS - PROC INT CONF ENTERP  |        1 |
| 10 |     10 | J RISK MANG FINANCIAL INST    |        1 |
| 11 |     11 | NORTHWEST J INTL LAW BUS      |        1 |
| 12 |     12 | J MONEY LAUND CONTROL         |        1 |
```
<BLANKLINE>
