...
>>> from techminer2.network_analysis.bibliographic_coupling.sources import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=20, 
...
... )
                            CL_0  ...                   CL_3
0                FINANCIAL INNOV  ...         J FINANC CRIME
1                        HELIYON  ...  J MONEY LAUND CONTROL
2  INTELL SYST ACCOUNT FINANCE M  ...                       
3                   J BANK REGUL  ...                       
4   ICEIS - PROC INT CONF ENTERP  ...                       
<BLANKLINE>
[5 rows x 4 columns]
