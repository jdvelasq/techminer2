...
>>> from techminer2.network_analysis.co_occurrence.index_keywords import communities_summary
>>> communities_summary(
...     #
...     # SUMMARY PARAMS:
...
... )
  Cluster  ...                                              Terms
0    CL_1  ...  REGULATORY_COMPLIANCE; FINANCE; REGTECH; SANDB...
1    CL_0  ...  FINANCIAL_INSTITUTIONS; ANTI_MONEY_LAUNDERING;...
