...
>>> from techminer2.network_analysis.co_citation.cited_sources import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=None, 
...
... ).head()
                  CL_0  ...                    CL_8
0  EUR BUS ORG LAW REV  ...  AFRICAN J INT COMP LAW
1         J BANK REGUL  ...           IBM J RES DEV
2   J ANTITRUST ENFORC  ...          J STRATEG MARK
3   CEUR WORKSHOP PROC  ...                        
4       CAP MARK LAW J  ...                        
<BLANKLINE>
[5 rows x 9 columns]
