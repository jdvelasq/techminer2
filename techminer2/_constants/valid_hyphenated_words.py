VALID_HYPHENATED_WORDS = frozenset(
    [
        "2-d",
        "3d-printing",
        "3-d",
        ...
        "wind-thermal-electroysis-battery",
        "wind-to-hydrogen",
        "wind-tunnel",
        "wind-turbine",
        "wind-wave",
