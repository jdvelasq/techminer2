...
>>> from techminer2.agenda.network.abstract_nlp_phrases import metrics
>>> metrics(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... ).head()
                                          Degree  ...  PageRank
MACHINE_LEARNING 04:007                        8  ...  0.104730
GLOBAL_FINANCIAL_CRISIS 06:177                 5  ...  0.106753
INTERNATIONAL_REGULATION 02:017                4  ...  0.077112
MAJOR_IMPACT 02:017                            4  ...  0.077112
POTENTIAL_TECHNOLOGICAL_SOLUTIONS 02:017       4  ...  0.077112
<BLANKLINE>
[5 rows x 4 columns]
