...
>>> from techminer2.agenda.network.index_keywords import communities
>>> communities(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... )
                           CL_0  ...                                  CL_2
0         FINANCIAL_CRISIS 2:07  ...      FINANCIAL_SERVICES_INDUSTRY 2:11
1     REGULATORY_FRAMEWORK 2:02  ...  CLASSIFICATION (OF_INFORMATION) 2:03
2  TECHNOLOGICAL_SOLUTIONS 2:02  ...          ARTIFICIAL_INTELLIGENCE 2:02
3    REGULATORY_TECHNOLOGY 2:01  ...                                      
<BLANKLINE>
[4 rows x 3 columns]
