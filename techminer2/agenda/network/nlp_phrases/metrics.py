...
>>> from techminer2.agenda.network.nlp_phrases import metrics
>>> metrics(
...     #
...     # AGENDA PARAMS:
...     occ_range=(2, None),
...
... ).head()
                                          Degree  ...  PageRank
MACHINE_LEARNING 04:007                        9  ...  0.118951
GLOBAL_FINANCIAL_CRISIS 06:177                 5  ...  0.100974
INTERNATIONAL_REGULATION 02:017                4  ...  0.075290
MAJOR_IMPACT 02:017                            4  ...  0.075290
POTENTIAL_TECHNOLOGICAL_SOLUTIONS 02:017       4  ...  0.075290
<BLANKLINE>
[5 rows x 4 columns]
