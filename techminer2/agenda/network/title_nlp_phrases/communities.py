...
>>> from techminer2.agenda.network.title_nlp_phrases import communities
>>> communities(
...     #
...     # AGENDA PARAMS:
...     occ_range=(1, None),
...
... )
                            CL_00  ...                              CL_11
0  CHARITABLE_ORGANISATIONS 1:003  ...  SMART_REGULATORY_COMPLIANCE 1:000
1          MACHINE_LEARNING 1:003  ...                                   
2   REGTECH_COMPLIANCE_TOOL 1:003  ...                                   
3         REGULATORY_BURDEN 1:003  ...                                   
<BLANKLINE>
[4 rows x 12 columns]
