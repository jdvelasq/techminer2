...
"""
.. _annual_scientific_production_prompt:

Annual Scientific Production Prompt
===============================================================================

>>> import techminer2plus as tm2p
>>> root_dir = "data/regtech/"
>>> prompt = tm2p.annual_scientific_production_prompt(
...     root_dir=root_dir,
... )
>>> print(prompt)
...
def annual_scientific_production_prompt(
    #
    # DATABASE PARAMS:
    root_dir: str = "./",
    database: str = "main",
