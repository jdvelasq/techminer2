...
>>> from techminer2.citation.network.countries import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=30, 
...
1          United States    Hong Kong   Greece
2                Bahrain      Belgium    India
3            Switzerland      Germany   Poland
4                  China   Luxembourg  Romania
5                  Italy       France         
6           South Africa    Indonesia         
7   United Arab Emirates     Malaysia         
8                  Japan  Netherlands         
9                 Jordan    Singapore         
10             Palestine                      
