...
>>> from techminer2.science_mapping.citation.network.organizations import item_density_visualization
...
def plot_node_density_from_organizations_citation_network(
    #
    # COLUMN PARAMS:
    top_n=None,
