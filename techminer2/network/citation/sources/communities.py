...
>>> from techminer2.citation.network.sources import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=30, 
...
... ).head()
                            CL_0  ...                           CL_3
0             CEUR WORKSHOP PROC  ...                     J ECON BUS
1   ICEIS - PROC INT CONF ENTERP  ...                FINANCIAL INNOV
2  INT CONF INF TECHNOL SYST INN  ...  HANDBBLOCKCHAIN, DIGIT FINANC
3                     DUKE LAW J  ...                 J FINANC CRIME
4             J ANTITRUST ENFORC  ...     J ADV RES DYN CONTROL SYST
<BLANKLINE>
[5 rows x 4 columns]
