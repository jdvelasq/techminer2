...
>>> from techminer2.citation.network.authors import communities
>>> communities(
...     #
...     # COLUMN PARAMS:
...     top_n=30, 
...
... ).head()
                CL_0         CL_1        CL_2
0  Anagnostopoulos I     Arman AA   Baxter LG
1       Kavassalis P     Arner DW   Brennan R
2             Gong X  Barberis JN  Breymann W
3           Grassi L   Buckley RP    Butler T
4              Lin W     Gross FJ     Crane M
