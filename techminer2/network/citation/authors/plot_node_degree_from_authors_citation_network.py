...
>>> from techminer2.science_mapping.citation.network.authors import degree_plot
>>> plot = degree_plot(
...     #
...     # COLUMN PARAMS:
...     top_n=30,
...
>>> plot.df_.head()
   Node                Name  Degree
0     0  Jagtiani J. 3:0317       2
1     1   Lemieux C. 2:0253       2
2     2    Gomber P. 2:1065       1
...
def plot_node_degree_from_authors_citation_network(
    #
    # COLUMN PARAMS:
    top_n=None,
