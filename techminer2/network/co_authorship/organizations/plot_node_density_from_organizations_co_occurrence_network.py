...
>>> from techminer2.science_mapping.co_authorship.network.organizations import item_density_visualization
...
def plot_node_density_from_organizations_co_occurrence_network(
    #
    # COLUMN PARAMS:
    top_n=None,
    occ_range=(None, None),
