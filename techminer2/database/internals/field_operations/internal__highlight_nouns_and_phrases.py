...
from ..internal__load_connectors import internal__load_connectors
from ..internal__load_determiners import internal__load_determiners
from ..internal__load_known_noun_phrases import internal__load_known_noun_phrases
from ..internal__load_technical_stopwords import internal__load_technical_stopwords
...
def internal__highlight_nouns_and_phrases(
    ...
    message(f"Highlighting tokens in '{source}' field.")
