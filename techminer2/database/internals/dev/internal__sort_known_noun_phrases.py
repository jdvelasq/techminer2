...
>>> from techminer2.database.internals.internal__sort_known_noun_phrases (
...     import internal__sort_known_noun_phrases
... )
...
def internal__sort_known_noun_phrases():
    ...
    file_path = pkg_resources.resource_filename(
        "techminer2",
        "database/subpackage_data/known_noun_phrases.txt",
    )
