...
>>> from techminer2.database.metrics.performance_metrics import BarPlot
>>> plot = (
...     BarPlot()
...     #
...
...     .build()
... )
>>> plot.write_html("sphinx/_generated/database/metrics/performance_metrics/bar_plot.html")

.. raw:: html

    <iframe src="../../../_generated/database/metrics/performance_metrics/bar_plot.html" 
