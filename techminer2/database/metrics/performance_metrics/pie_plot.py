...
>>> from techminer2.database.metrics.performance_metrics import PiePlot
>>> plot = (
...     PiePlot()
...     #
...
...     .build()
... )
>>> plot.write_html("sphinx/_generated/database/metrics/performance_metrics/pie_plot.html")

.. raw:: html

    <iframe src="../../../_generated/database/metrics/performance_metrics/pie_plot.html" 
