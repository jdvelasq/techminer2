...
>>> from techminer2.database.metrics.collaboration_metrics import BarPlot
>>> plot = (
...     BarPlot()
...     #
...
...     .build()
... )
>>> plot.write_html("sphinx/_generated/database/metrics/collaboration_metrics/bar_plot.html")

.. raw:: html

    <iframe src="../../../_generated/database/metrics/collaboration_metrics/bar_plot.html" 
