...
Example:
    ...
    CONVERGENCE; FINANCE; TECHNOLOGY; THIS_STUDY; THE_LENS; ACTOR_NETWORK_THEORY;
    A_MULTI_LEVEL_ANALYSIS; THE_HISTORICAL_DEVELOPMENT; CHINA; FINANCIAL_TECHNOLOGY;
    FINTECH; INDUSTRY; THE_PROCESS; BUILDING; A_VARIETY; NETWORKS;
    HETEROGENEOUS_ACTORS; THE_NEWLY_EMERGING_CONVERGENCE_INDUSTRY; THIS_RESEARCH;
    A_STEPPING_STONE; THE_INTERACTION; FINTECH; SOCIAL_AND_POLITICAL_CONTEXT;
    DISCUSSES_POLICY_IMPLICATIONS; CHINA_FINTECH_INDUSTRY; THE_CHANGING_ROLE;
    THE_STATE; THE_GROWTH; NATIONAL_INDUSTRY; CHINA; ELSEVIER_LTD
