...
.. raw:: html
    ...
    <iframe src="../_generated/px.discover.overview.annual_scientific_production.ranking_chart.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from techminer2.discover.overview.annual_scientific_production import RankingChart
    >>> fig = (
    ...     RankingChart()
    ...     #
