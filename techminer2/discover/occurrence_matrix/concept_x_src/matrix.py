...
Smoke tests:
    ...
    >>> from techminer2.discover.occurrence_matrix.concept_x_src import Matrix
    >>> df = (
    ...     Matrix()
    ...     #
    ...     # COLUMNS:
    ...
    INT REV FINANC ANAL 005:00992                                5  ...                  1
    FINANC INNOV 005:00877                                       5  ...                  0
    EUR J FINANC 004:01002                                       4  ...                  0
    SUSTAIN (SWITZERLAND) 004:00741                              4  ...                  1
    RES INT BUS FINANC 004:00530                                 4  ...                  2
    IND MANAG DATA SYST 003:01154                                3  ...                  0
    J ECON BUS 003:00886                                         3  ...                  1
