...
.. raw:: html
    ...
    <iframe src="../_generated/px.discover.occurrence_matrix.ctry_x_org.bubble_chart.html"
    height="800px" width="100%" frameBorder="0"></iframe>

Smoke tests:
    >>> from techminer2 import ItemsOrderBy
    >>> from techminer2.discover.occurrence_matrix.ctry_x_org import BubbleChart
    >>> fig = (
    ...     BubbleChart()
    ...     #
    ...     # COLUMNS:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discover.occurrence_matrix.ctry_x_org.bubble_chart.html")
