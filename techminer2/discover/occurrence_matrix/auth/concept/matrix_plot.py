...
.. raw:: html
    ...
    <iframe src="../_generated/px.discover.occurrence_matrix.auth.concept.matrix_plot.html"
    height="600px" width="100%" frameBorder="0"></iframe>


Smoke tests:
    >>> from techminer2 import ItemsOrderBy
    >>> from techminer2.discover.occurrence_matrix.auth.concept import MatrixPlot
    >>> fig = (
    ...     MatrixPlot()
    ...     #
    ...     # COLUMNS:
    ...
    >>> type(fig).__name__
    'Figure'
    >>> fig.write_html("docsrc/_generated/px.discover.occurrence_matrix.auth.concept.matrix_plot.html")
