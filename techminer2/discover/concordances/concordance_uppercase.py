...
Smoke test:
    ...
    >>> from techminer2.analyze.concordances import ConcordanceUppercase
    >>> contexts = (
...
class ConcordanceUppercase(
    ...
    def run(self):
        ...
        from techminer2.discover.concordances import ConcordanceUser

        return (
            ConcordanceUser()
            .update(**self.params.__dict__)
            .with_source_field(CorpusField.ABS_UPPER)
            .run()
        )
