...
>>> from techminer2.tech_mining.pca.tfidf_matrix.hierarchical import cluster_centers
>>> cluster_centers(
...     #
...     # PARAMS:
...
LABELS                                                  
CL_0   -0.264367 -0.181571 -0.285135 -0.433019  0.125550
CL_1   -0.336099  1.208814  0.437619 -0.150239 -0.215090
...
def compute_hierarchical_cluster_centers_from_tfidf_pca_embedding(
    #
    # PARAMS:
    field,
    #
