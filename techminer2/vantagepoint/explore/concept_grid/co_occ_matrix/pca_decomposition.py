...
>>> factors = vantagepoint.explore.concept_grid.co_occ_matrix.pca_decomposition(
...     root_dir="data/regtech/",
...
from ....discover.factor_matrix.co_occ_matrix.pca_decomposition import (
    pca_decomposition as factor_pca_decomposition,
)
...
def pca_decomposition(
    ...
    **filters,
    ...
    factor_matrix = factor_pca_decomposition(
        #
        # COOC PARAMS:
