...
to the 'column' column of the list, and the rows of the original matrix correspond
to the 'row' column of the list. The value of the cell is stored in the 'value' 
column of the list.
...
>>> obj = vantagepoint.analyze.list_cells_in_matrix(r)
>>> obj.matrix_.head()
                row            column  CORR
