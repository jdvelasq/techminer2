...
>>> from techminer2.tech_mining.svd.tfidf_matrix.kmeans import communities
>>> communities(
...     #  
...     # PARAMS:
...     field="nlp_phrases",
...
... ).head()
                           CL_0  ...                  CL_5
0                AUTHOR 18:2443  ...  TECHNOLOGIES 23:3317
1  FINANCIAL_TECHNOLOGY 17:2225  ...                      
2               RESULTS 11:1810  ...                      
3          NEW_SERVICES 10:1734  ...                      
4                  DATA 10:1569  ...                      
<BLANKLINE>
[5 rows x 6 columns]
...
def generate_kmeans_communities_from_tfidf_svd_embedding(
    #
    # PARAMS:
    field,
    #
