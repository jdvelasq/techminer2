...
from .compute_kmeans_cluster_centers_from_tfidf_svd_embedding import compute_kmeans_cluster_centers_from_tfidf_svd_embedding
from .generate_kmeans_communities_from_tfidf_svd_embedding import generate_kmeans_communities_from_tfidf_svd_embedding


def plot_kmeans_factor_map_from_tfidf_svd_embedding(
    #
    # PARAMS:
    field,
    #
    ...
    **filters,
    ...
    centers = compute_kmeans_cluster_centers_from_tfidf_svd_embedding(
        #
        # PARAMS:
        field=field,
        #
    ...
    members = generate_kmeans_communities_from_tfidf_svd_embedding(
        #
        # PARAMS:
        field=field,
        #
