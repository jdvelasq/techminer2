...
... ).write_html("sphinx/_static/analyze/co_authorship/network/authors/item_density_visualization.html")

.. raw:: html

    <iframe src="../../../../../../_static/analyze/co_authorship/network/authors/item_density_visualization.html" 
...
def plot_node_density_from_authors_co_occurrence_network(
    #
    # COLUMN PARAMS:
    top_n=None,
    occ_range=(None, None),
